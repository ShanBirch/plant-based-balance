const CACHE_NAME = 'pbb-app-v350-photo-ready-tour'; // v350: photo-ready onboarding handoff and unobstructed voice-note gate
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=197-photo-ready-tour',
