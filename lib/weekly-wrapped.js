...
(function(){
  ...
  function buildChallengeWeekOneSlides(stats){
    ...
    return [
      { bg: 'ww-bg-challenge-week', hold_ms: 3000, html: `
      ...
      `},
      { bg: 'ww-bg-challenge-action', hold_ms: 3300, html: `
        <div class="ww-speed-lines"></div>
      ...
      `},
      { bg: 'ww-bg-challenge-score', hold_ms: 3200, html: `
        <div class="ww-halftone"></div>
        <div class="ww-challenge-pill">records board</div>
        <div class="ww-big-num" style="font-size: clamp(5rem, 24vw, 12rem); color:#101820; text-shadow:5px 5px 0 #f8f3e7;">${pbs}</div>
        <div class="ww-caption" style="color:#101820; font-weight:900;">PBs hit in week one</div>
      `},
      { bg: 'ww-bg-challenge-week', hold_ms: 3300, html: `
        ${challengeTape('tracked - trained - showed up')}
        <div class="ww-challenge-pill coral">nutrition stack</div>
        <div class="ww-big-num" style="font-size: clamp(5rem, 24vw, 12rem); color:#f8f3e7; text-shadow:6px 6px 0 #101820;">${meals}</div>
        <div class="ww-caption" style="max-width:86%; color:#f8f3e7;">meals tracked by the squad</div>
      `},
      { bg: 'ww-bg-challenge-night', hold_ms: 3800, html: `
        <div class="ww-speed-lines"></div>
      ...
      `},
      { bg: 'ww-bg-challenge-score', hold_ms: 3400, html: `
        <div class="ww-halftone"></div>
