const CACHE_NAME = 'pbb-app-v466-activity-meal-complete'; // v466: matching activity and meal completion photo-share flows
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=59-activity-complete-share',
