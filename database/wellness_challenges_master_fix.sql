...
-- 5. GRANTS
GRANT EXECUTE ON FUNCTION create_wellness_challenge(TEXT, UUID, DATE, DATE, INT, TEXT, INT, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION join_wellness_challenge(UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION leave_wellness_challenge(UUID, UUID) TO authenticated;
