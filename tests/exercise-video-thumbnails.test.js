...
test('phones fetch the thumbnail renderer and video logic together', () => {
    const workoutVersion = 'dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=186-onboarding-motion';
    ...
    assert.match(serviceWorkerSource, /const CACHE_NAME = 'pbb-app-v321'/);
});
