...
- Founders Pass path: the branded page is https://plantbased-balance.org/founders. It explains the AU$89.99 fixed six-week offer and no-auto-renewal terms, collects legal acceptance, and opens Stripe Checkout. Payment is not complete until Stripe confirms it. After a successful purchase, the buyer is taken to https://plantbased-balance.org/login.html?action=signup to create or access their Balance account.
