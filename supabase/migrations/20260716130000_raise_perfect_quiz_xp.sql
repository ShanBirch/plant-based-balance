-- Raise Health IQ quiz rewards:
-- - Every newly completed quiz at 100% earns 5 XP.
-- - The client adds a once-daily 10 XP bonus for the Daily Quiz, for 15 XP total.
-- Existing active-challenge 2x XP behavior remains unchanged.
