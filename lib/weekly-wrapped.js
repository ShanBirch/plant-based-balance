...
(function(){
  ...
  function buildAskMotivationReel(){
    ...
    return [
      ...
      // ── WILLPOWER OBJECTION ──────────────────────────────────
      twLine('user', 'So it\'s not willpower?',                                             { speed: FAST, pause: 700 }),
      twLine('gpt',  'Willpower is just <strong>another prediction</strong>.',              { speed: SLOW, pause: 1000 }),
      twLine('gpt',  'The <em>"I\'ll be different this time"</em> prediction…',             { speed: NORM, pause: 700 }),
      twLine('gpt',  'fighting the <em>"I always do this"</em> prediction.',                { speed: NORM, pause: 1000 }),
      twLine('gpt',  'One has ten reps behind it.',                                         { speed: NORM, pause: 700 }),
      twLine('gpt',  'The other has ten <strong>thousand</strong>.',                         { speed: SLOW, pause: 900 }),
      twLine('gpt',  'Guess which one wins.',                                               { speed: SLOW, pause: 1400 }),

      // ── THE LEVER ────────────────────────────────────────────
      twLine('gpt',  'But you <strong>can</strong> give your brain new things to predict.', { speed: SLOW, pause: 1000 }),
