const CACHE_NAME = 'pbb-app-v395-phone-test-reset'; // v395: fresh account reset overrides stale phone completion state
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=212-phone-test-reset',
