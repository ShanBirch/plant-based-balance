...
test('phones fetch the thumbnail renderer and video logic together', () => {
  const workoutVersion = 'dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=200-photo-stage';
  ...
  assert.match(serviceWorkerSource, /const CACHE_NAME = 'pbb-app-v353-photo-stage'/);
});
