const CACHE_NAME = 'pbb-app-v463-ten-workout-styles'; // v463: fullscreen workout completion plus ten tap-through share layouts
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=57-ten-workout-styles',
