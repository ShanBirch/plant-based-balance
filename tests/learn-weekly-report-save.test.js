...
function fixture(){
 ...
 const query=async(url,options={})=>{
   ...
   if(url.startsWith('social_journey_progress'))return [{current_week:1,week_started_at:'2026-09-09'}];
 ...
 vm.runInNewContext(source,{module,exports:module.exports,Date:FixedDate,console:{error(){},warn(){}},fetch:async()=>({ok:true,json:async()=>({id:'member'})}),require:p=>p==='crypto'?require('crypto'):p==='../../lib/learn-weekly-actions'?require('../lib/learn-weekly-actions'):helpers});
