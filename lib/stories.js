...
const SHANNON_FEED_REVIEW_EMAIL = 'shannonrhysbirch@gmail.com';
...
function isShannonFeedReviewer() {
    return !!(window.currentUser
        && String(window.currentUser.email || '').toLowerCase() === SHANNON_FEED_REVIEW_EMAIL);
}
...
async function refreshFeedAfterTahliaApproval() {
