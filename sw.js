const CACHE_NAME = 'pbb-app-v290'; // v290: Sunday-only default weigh-in schedule after lesson contrast fix
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=175',
