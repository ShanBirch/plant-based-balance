...
assert.ok(dashboard.includes('dashboard-script-10-points_widget_functions.js?v=59-activity-complete-share'), 'phones must load the new share composer');
assert.ok(dashboard.includes('dashboard-script-11-calorie_tracker_functions.js?v=40-meal-complete-share'), 'phones must load the current meal tracker controls');
...
assert.ok(serviceWorker.includes("const CACHE_NAME = 'pbb-app-v466-activity-meal-complete'"), 'the app shell cache must be refreshed');
assert.ok(serviceWorker.includes('dashboard-script-10-points_widget_functions.js?v=59-activity-complete-share'), 'the new share composer must be precached');
