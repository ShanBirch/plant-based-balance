...
- Feed and social: one regular daily check-in post to Feed can earn +2 XP per Brisbane day. Commenting on someone else's Feed post earns +2 XP. Eligible food and workout shares earn +15 XP once per Brisbane day in Balance Feed and another independent +15 XP in Instagram Feed. Each tracked walk, run, ride, or activity can earn +15 XP once in Balance Feed and another independent +15 XP in Instagram Feed. Nudging an inactive friend from Home earns +1 XP, capped once per friend per week.
