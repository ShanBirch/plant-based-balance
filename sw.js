const CACHE_NAME = 'pbb-app-v248'; // v248: stable Add Set focus, Share a Set captions, and confirmed PB sharing
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=142',
  './js/dashboard/dashboard-script-7-video_logic.js?v=20260603-video-stream',
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=23',
