...
- Approval draft only. Do not publish.
- Client-identifiable footage and conversation excerpts require confirmed public-use permission before posting.
- Keep Shane's exact wording where quoted. Do not imply that the dedicated block began at 100 kg: he logged 130 kg before the block was assigned.
- Use `plant-based` rather than `vegan` in any public Balance positioning.
