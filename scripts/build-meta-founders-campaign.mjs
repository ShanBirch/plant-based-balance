...
const campaigns = [
  {
    ...
    primaryText: "You haven't failed. The plan was wrong. It wasn't built around your brain, what you've been through, or what you're dealing with now. Inside Balance, I coach plant-based people with small, clear steps that fit their current starting point. The Founders Pass is AU$99 once. Message “BALANCE” and I'll show you what's included.",
...
const campaignPlan = {
  ...
  ads: exportsList.map((x, index) => ({
    ...
    primaryText: "You haven't failed. The plan was wrong. It wasn't built around your brain, what you've been through, or what you're dealing with now. Your brain learns through repetition, and your environment shapes what gets repeated. Inside Balance, I coach plant-based people with small, clear steps built around their current starting point. The Founders Pass is a one-off payment of AU$99. Message “BALANCE” and I'll show you what's included.",
