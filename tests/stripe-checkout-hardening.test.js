...
assert(
    ...
    checkout.includes("'founders-pass': { amount: Date.now() < Date.parse('2026-09-21T00:00:00+10:00') ? 15000 : 45000, label: 'Balance Learn', successPlan: 'balance_foundations_six_week' }") &&
