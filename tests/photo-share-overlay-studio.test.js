...
assert.ok(dashboard.includes('dashboard-script-10-points_widget_functions.js?v=61-exact-activity-share'), 'phones must load the new share composer');
...
assert.ok(serviceWorker.includes("const CACHE_NAME = 'pbb-app-v470-share-studio-rollout'"), 'the app shell cache must be refreshed');
assert.ok(serviceWorker.includes('dashboard-script-10-points_widget_functions.js?v=61-exact-activity-share'), 'the new share composer must be precached');
