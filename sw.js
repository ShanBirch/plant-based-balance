const CACHE_NAME = 'pbb-app-v244'; // v244: start exercise video uploads after native prompts close; v243: let exercise video uploads finish in background
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=129',
