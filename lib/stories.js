...
// Keep HD clips and upload large media directly to B2 instead of through Netlify's body limit.
...
async function uploadStoryMediaDirectToBackblaze(file, options = {}) {
    ...
    const startResponse = await fetch('/api/create-story-media-upload', {
        method: 'POST',
        headers: {
