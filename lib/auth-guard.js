...
(async function() {
  ...
  try {
    ...
    if (isMale) {
      ...
      // Aggressively replace "The Flush" with "Performance Mode" before paint (optimized)
      ...
      // Also run once on DOMContentLoaded in case we missed it
