...
async function uploadFeedComposerMedia(file, mediaType, postBtn, options = {}) {
    ...
    try {
        ...
        console.warn('Feed image upload failed; saving compressed image data instead:', error);
        if (postBtn) postBtn.textContent = 'Saving photo...';
        mediaUrl = imageDataUrl;
        uploadData = {
            fallback: 'data_url',
            contentType: fileToUpload.type || file.type || 'image/jpeg',
            size: fileToUpload.size || file.size || null,
