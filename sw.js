const CACHE_NAME = 'pbb-app-v256'; // v256: content greeting and quieter level progress card
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=147',
