  ...
  function buildChallengeReel(){
    return [
      ...
      { bg: 'ww-bg-jackpot', hold_ms: 4000, html: `
        ...
        <div class="ww-stamp gold" style="margin-top:18px;">3 WINNERS</div>
      `},
      // 2. FREE to enter
      ...
      `},
      // 3. RULES — start date + 30 days + top 3 win
      { bg: 'ww-bg-electric', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Starts 27 April · runs 30 days</div>
        <div class="ww-big-num" style="font-size: clamp(3rem, 13vw, 6.4rem); line-height:1.05;">TOP 3<br>WIN.</div>
        <div class="ww-caption" style="margin-top:12px;">Highest XP gained after 30 days. That's it.</div>
      `},
      // 4. WAYS TO EARN XP
      ...
      `},
      // 5. LEADERBOARD — podium, top 3 highlighted
      { bg: 'ww-bg-aurora', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Live leaderboard · top 3 win</div>
        <div style="display:flex; flex-direction:column; gap:8px; margin-top:14px; width:min(320px, 82vw); font-family:'Inter',sans-serif; font-weight:800;">
          <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(251,191,36,0.95); color:#1a0a00; padding:10px 14px; border:3px solid #000; border-radius:10px; box-shadow:4px 4px 0 #000; font-size:1rem;"><span>🥇 #1</span><span>12,480 XP</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(203,213,225,0.95); color:#1a0a00; padding:10px 14px; border:3px solid #000; border-radius:10px; box-shadow:4px 4px 0 #000; font-size:0.95rem;"><span>🥈 #2</span><span>11,205 XP</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(217,119,6,0.95); color:#fff; padding:10px 14px; border:3px solid #000; border-radius:10px; box-shadow:4px 4px 0 #000; font-size:0.9rem;"><span>🥉 #3</span><span>9,740 XP</span></div>
          <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.88); color:#1a0a00; padding:8px 14px; border:3px solid #000; border-radius:10px; box-shadow:4px 4px 0 #000; font-size:0.85rem;"><span>… YOU?</span><span>__,___ XP</span></div>
        </div>
      `},
      // 6. STAKES — top 3 share the giveaway
      { bg: 'ww-bg-jackpot', hold_ms: 4800, html: `
        <div class="ww-halftone"></div>
        ...
        <div class="ww-stamp gold" style="margin-top:14px;">TOP 3 WIN</div>
      `},
      // 7. URGENCY — the date
      ...
      `},
      // 8. CTA — download + enter
      { bg: 'ww-bg-intro', hold_ms: 8500, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-halftone"></div>
        ${REEL_LOGO}
        <div class="ww-big-num" style="font-size: clamp(2.2rem, 9vw, 4.4rem); margin-top:20px; line-height:1;">BALANCE</div>
        <div class="ww-caption" style="font-size:0.9rem; margin-top:4px; opacity:0.92;">$500 Giveaway · Top 3 win · Starts 27 April</div>
        <div style="display:flex; gap:10px; margin-top:22px; flex-wrap:wrap; justify-content:center;">
          <div class="ww-store-pill">📱 App Store</div>
          <div class="ww-store-pill">▶ Google Play</div>
        </div>
        <div class="ww-stamp gold" style="margin-top:20px;">DOWNLOAD FREE</div>
        <button class="ww-cta-btn" data-ww-finish style="margin-top:20px;">Done</button>
      `},
    ];
  }
