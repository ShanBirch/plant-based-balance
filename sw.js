const CACHE_NAME = 'pbb-app-v531-fitgotchi-home-overlay'; // v531: float the Home guide over existing content without inserting a blank spacer
...
const ASSETS = [
  ...
  './lib/meta-ad-trial.js?v=19-server-test-reset',
