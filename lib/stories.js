...
window.renderMealCard = function(cardData) {
    ...
    const displayFoods = escapeHtml(String(foods).toUpperCase());

    return `
        <div class="feed-meal-card" style="width:100%; aspect-ratio:4/5; background:${cardBackground}; position:relative; overflow:hidden; color:#fff; text-shadow:0 2px 8px rgba(0,0,0,0.56);">
            ${backgroundPhotoHtml}
            <div style="position:absolute; inset:0; z-index:1; background:linear-gradient(180deg, rgba(4,12,9,0.56) 0%, rgba(4,12,9,0) 28%, rgba(4,12,9,0.08) 44%, rgba(4,12,9,0.78) 100%);"></div>

            <div style="position:absolute; top:42px; left:24px; right:24px; z-index:2; display:flex; align-items:center; gap:10px;">
                <img src="balance_logo_transparent.png" alt="Balance" style="width:46px; height:46px; object-fit:contain; display:block; flex:0 0 auto;">
                <div style="font-size:0.9rem; line-height:1; font-weight:900; letter-spacing:1.5px; color:#fff;">BALANCE</div>
            </div>

            <div style="position:absolute; left:24px; right:24px; bottom:44px; z-index:2; box-sizing:border-box; padding:22px 22px 18px; border:1px solid rgba(255,255,255,0.72); border-radius:20px; background:rgba(10,15,13,0.62);">
                <div class="feed-meal-card-title" style="font-size:1.2rem; line-height:1.08; font-weight:900; color:#fff; text-transform:uppercase; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden;">${displayFoods}</div>
                <div style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); margin-top:18px;">
                    <div style="min-width:0; padding-right:8px;">
                        <div class="feed-meal-card-macro-value" style="font-size:1.15rem; line-height:1; color:#f5c45c; font-weight:900;">${calories > 0 ? calories : '-'}</div>
                        <div class="feed-meal-card-muted" style="font-size:0.62rem; margin-top:7px; color:rgba(255,255,255,0.88); font-weight:800;">kcal</div>
                    </div>
                    <div style="min-width:0; padding:0 8px; border-left:1px solid rgba(255,255,255,0.28);">
                        <div class="feed-meal-card-macro-value" style="font-size:1.15rem; line-height:1; color:#c9b7ff; font-weight:900;">${protein}g</div>
                        <div class="feed-meal-card-muted" style="font-size:0.62rem; margin-top:7px; color:rgba(255,255,255,0.88); font-weight:800;">protein</div>
                    </div>
                    <div style="min-width:0; padding:0 8px; border-left:1px solid rgba(255,255,255,0.28);">
                        <div class="feed-meal-card-macro-value" style="font-size:1.15rem; line-height:1; color:#c9b7ff; font-weight:900;">${carbs}g</div>
                        <div class="feed-meal-card-muted" style="font-size:0.62rem; margin-top:7px; color:rgba(255,255,255,0.88); font-weight:800;">carbs</div>
                    </div>
                    <div style="min-width:0; padding-left:8px; border-left:1px solid rgba(255,255,255,0.28);">
                        <div class="feed-meal-card-macro-value" style="font-size:1.15rem; line-height:1; color:#c9b7ff; font-weight:900;">${fat}g</div>
                        <div class="feed-meal-card-muted" style="font-size:0.62rem; margin-top:7px; color:rgba(255,255,255,0.88); font-weight:800;">fat</div>
                    </div>
                </div>
                <div style="font-size:0.62rem; margin-top:18px; color:rgba(255,255,255,0.72); font-weight:750;">Fuel. Track. Level up.</div>
            </div>
        </div>
    `;
};
