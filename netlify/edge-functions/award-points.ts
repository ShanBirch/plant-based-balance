...
const WALKTHROUGH_REFERENCE_IDS: Record<string, string> = {
  ...
  'walkthrough:tour-01': '00000000-0000-4000-8000-000000000111',
  'walkthrough:tour-02': '00000000-0000-4000-8000-000000000112',
  'walkthrough:tour-03': '00000000-0000-4000-8000-000000000113',
  'walkthrough:tour-04': '00000000-0000-4000-8000-000000000114',
  'walkthrough:tour-05': '00000000-0000-4000-8000-000000000115',
  'walkthrough:tour-06': '00000000-0000-4000-8000-000000000116',
  'walkthrough:tour-07': '00000000-0000-4000-8000-000000000117',
  'walkthrough:tour-08': '00000000-0000-4000-8000-000000000118',
  'walkthrough:tour-09': '00000000-0000-4000-8000-000000000119',
  'walkthrough:tour-10': '00000000-0000-4000-8000-000000000120',
  'walkthrough:tour-11': '00000000-0000-4000-8000-000000000121',
  'walkthrough:tour-12': '00000000-0000-4000-8000-000000000122',
};
...
export default async (request: Request, context: Context): Promise<Response> => {
  ...
  try {
        ...
        return new Response(JSON.stringify({
          ...
          reason: type === 'walkthrough'
            ...
            : type === 'milestone_feed_share'
              ? 'You already earned XP for sharing this milestone.'
    ...
    // personal_best, workout_feed_share, milestone_feed_share, exercise_contribution, daily_log, and walkthrough types don't update specific counters.
