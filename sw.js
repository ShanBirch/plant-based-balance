const CACHE_NAME = 'pbb-app-v346-meta-preview-soundtrack'; // v346: add gentle paid-preview music with voice-note ducking
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=195-gentle-audio',
