...
(function(){
  ...
  function buildAskMotivationReel(){
    ...
    return [
      ...
      twLine('gpt',  'No. Willpower is <em>you</em> fighting the prediction.',              { speed: NORM, pause: 900 }),
      twLine('gpt',  'It works for a second.',                                              { speed: SLOW, pause: 700 }),
      twLine('gpt',  'Then the prediction wins.',                                           { speed: SLOW, pause: 900 }),
      twLine('gpt',  'You can\'t out-argue a prediction confirmed a thousand times.',       { speed: NORM, pause: 1200 }),
