/**
 * Netlify Edge Function to upload chat photos to Backblaze B2
 * Handles photo attachments in direct messages and group chats
 */
...
export default async (request, context) => {
    ...
    try {
        ...
        const fileName = `chats/${userId}/${timestamp}.${fileExtension}`;
        ...
        const uploadResponse = await fetch(uploadUrl, {
            ...
            headers: {
                ...
                'X-Bz-Info-upload-type': 'chat-photo'
            },
            body: fileBuffer
        });
        ...
        console.error('Error in upload-chat-photo:', error);
        return new Response(JSON.stringify({
