...
if (typeof window.addEventListener !== 'undefined') {
    window.addEventListener('load', function() {
        if (window.currentUser) {
            ...
            // Light cleanup of very old posts (90+ days) — runs once daily
            // No longer deletes after 24h; feed posts are permanent
            cleanupExpiredStories().catch(e => console.warn('Cleanup error:', e));
        }
    });
}
