...
const CHALLENGE_TYPES = {
    ...
    calories: { emoji: '🍎', name: 'Calories',  desc: 'Most days with macros & calories on target', subtitle: '30-day nutrition battle', color: '#4ade80', howStep2: 'Hit within <strong style="color: #4ade80;">20% of your calorie & macro goals</strong> each day and claim your daily bonus.', howStep3: 'Every <strong style="color: #4ade80;">day with macros & calories successfully tracked</strong> = 1 point.' },
