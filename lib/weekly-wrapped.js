...
(function(){
  ...
  function buildAskConditioningReel(){
    ...
    return [
      ...
      // ── VERSION 3 — YOU ──────────────────────────────────────
      twLine('user', 'So is this happening to me?',                                         { speed: FAST, pause: 700 }),
      twLine('gpt',  'Every day.',                                                          { speed: SLOW, pause: 800 }),
      twLine('gpt',  'You just never noticed.',                                             { speed: SLOW, pause: 1100 }),
      twLine('gpt',  'Phone buzzes → dopamine fires. Before you\'ve even read the message.', { speed: NORM, pause: 1000 }),
      twLine('gpt',  'Fridge door at 9pm → craving. Before you\'re even hungry.',           { speed: NORM, pause: 1000 }),
      twLine('gpt',  'Gym car park → dread, or pride. Depending on which one got paired.',  { speed: NORM, pause: 1200 }),

      // ── REALISATION — the whole universe is running this on you ─
      twLine('gpt',  'Your life is made of <strong>pairings</strong>.',                     { speed: SLOW, pause: 900 }),
      twLine('gpt',  'Honestly… that\'s understating it.',                                  { speed: SLOW, pause: 1000 }),
      twLine('gpt',  'The <strong>whole universe</strong> is running this program on you.',  { speed: SLOW, pause: 1200 }),
      twLine('gpt',  'Right now.',                                                          { speed: SLOW, pause: 1100 }),
      twLine('gpt',  'Every song from a summer you\'ll never get back.',                     { speed: NORM, pause: 900 }),
      twLine('gpt',  'Every smell from your grandmother\'s kitchen.',                        { speed: NORM, pause: 900 }),
      twLine('gpt',  'Every voice that ever said your name.',                               { speed: NORM, pause: 900 }),
      twLine('gpt',  'Every fluorescent light in every school hallway.',                    { speed: NORM, pause: 900 }),
      twLine('gpt',  'Every rainy morning at a bus stop.',                                  { speed: NORM, pause: 1000 }),
      twLine('gpt',  'All of it paired with something you felt.',                           { speed: NORM, pause: 900 }),
      twLine('gpt',  'All of it quietly teaching you what to love, what to fear, what to crave, what to avoid.', { speed: NORM, pause: 1300 }),
      twLine('gpt',  'You didn\'t agree to any of it.',                                      { speed: SLOW, pause: 1000 }),
      ...
      twLine('user', 'So how do I un-teach the bad pairs?',                                 { speed: FAST, pause: 800 }),
      ...
      // ── THE DEEPER CATCH + THE RESOLUTION ────────────────────
      twLine('user', 'But hang on —',                                                       { speed: FAST, pause: 500 }),
      twLine('user', 'if my old predictions don\'t <em>want</em> me to starve or replace…',  { speed: FAST, pause: 600 }),
      ...
      twLine('gpt',  'You can only <strong>learn</strong>.',                                { speed: SLOW, pause: 1300 }),

      // The reveal — the viewer IS the answer, right now
      twLine('gpt',  'And here\'s the thing.',                                              { speed: SLOW, pause: 800 }),
      twLine('gpt',  'You\'re doing it <em>right now</em>.',                                 { speed: SLOW, pause: 1200 }),
      twLine('gpt',  'Watching this. Thinking about this. Letting the idea in.',            { speed: NORM, pause: 1000 }),
      twLine('gpt',  'That\'s a new pair being filed in your engine.',                       { speed: NORM, pause: 1100 }),
      twLine('gpt',  'The universe conditioned you without ever asking.',                   { speed: NORM, pause: 1100 }),
      twLine('gpt',  'This is one of the first things you get to <strong>choose</strong>.',  { speed: SLOW, pause: 1300 }),
      twLine('gpt',  'If you stay —',                                                       { speed: SLOW, pause: 600 }),
      twLine('gpt',  'if you keep feeding your engine ideas like this one —',               { speed: NORM, pause: 900 }),
      twLine('gpt',  'it <strong>will</strong> change you.',                                 { speed: SLOW, pause: 1100 }),
      twLine('gpt',  'You don\'t have to want the change.',                                 { speed: SLOW, pause: 1000 }),
      twLine('gpt',  'The learning will do it for you.',                                    { speed: SLOW, pause: 1400 }),
