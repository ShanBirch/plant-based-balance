...
(function () {
    ...
    function render(data = current()) {
        ...
        host.innerHTML = `<div id="course-learning-home" class="course-detail-page course-structured course-week-page">
            ...
            <section class="master-course"><h3>Your weekly practice</h3>
        ...
        host.querySelector('#master-form').addEventListener('submit', async e => {
            ...
            if (!window.BalanceCourseLayout.requirements('master',stageIndex+1).complete) { status('Complete this week’s lesson quizzes before completing the week.',true); return; }
