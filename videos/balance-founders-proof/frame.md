...
description: >
  ...
  accent, the three-step gray text ladder, Montserrat (display/numerals/chrome) + Montserrat (body),
...
colors:
  ...
  text-muted: "#D8A43A"
  text-light: "#9A9A9A"
  accent-light: "rgba(169, 111, 0, 0.08)"
  accent-medium: "rgba(169, 111, 0, 0.15)"
  border: "rgba(169, 111, 0, 0.2)"
  card-bg: "rgba(169, 111, 0, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Montserrat body + Montserrat chrome) —
  body:    { fontFamily: "Montserrat", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
...
- **Fonts** — already set to **Montserrat** (display) / **Playfair Display** (body); ignore any preset font name lingering in prose.
...
eyebrows uppercase 0.08em) and **Montserrat** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Montserrat** (display/numerals/chrome) + **Montserrat** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Montserrat body 0.85cqw muted; Montserrat eyebrow uppercase 0.08em
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Montserrat 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Focal** a row of tinted cards — cobalt `metric-value` + Montserrat label + muted desc + optional
...
Montserrat body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Montserrat 400 muted, line 1.6.
...
- **Type** — Montserrat headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Montserrat body muted line 1.6; ≥1.4cqw floor.
...
- **Montserrat + Montserrat via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
