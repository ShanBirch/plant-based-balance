...
assert.ok(dashboard.includes('dashboard-script-10-points_widget_functions.js?v=62-locked-photo-text-tools'), 'phones must load the new share composer');
...
assert.ok(serviceWorker.includes("const CACHE_NAME = 'pbb-app-v490-locked-share-photo'"), 'the app shell cache must be refreshed');
assert.ok(serviceWorker.includes('dashboard-script-10-points_widget_functions.js?v=62-locked-photo-text-tools'), 'the new share composer must be precached');
