...
const APPROVED_COACHING_URL = 'https://plantbased-balance.org/founders';
...
function classifyNeedsYou(alert = {}) {
    ...
    if (isAlwaysNeedsYouPerson(alwaysNeedsYouIdentity) && !kayProgramOrFixBypass) {
        reasons.push('always_needs_you_person');
        labels.push('Nat/Shane/Arunima/Fra/Kay/Jazz/Miranda/Monica/Dani draft-only Needs You route');
    }
    if (appProblemHold) {
