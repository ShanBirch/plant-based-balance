 ...
 * `won`, `lost`, `paused`. `pitched` means Shannon offered Balance Learn.
...
const STAGES = [
    ...
    },
    {
        ...
        index: 4,
        label: 'Commitment',
        what_to_learn: 'ready-to-start signal for Balance Learn + the real-life change pattern the course can naturally support',
...
function buildEvaluationPrompt({ leadName, channel, currentQualifier, history, currentMessage, draftText, customData, meaningfulLeadReplyCount }) {
    ...
    return `You are scoring a lead's progress through a 4-stage qualifier funnel for Shannon, who is currently offering Balance Learn. It is one AUD $149 payment for the full eight weeks, does not need a phone call, and includes a fixed eight-week course, eight weeks of app/community access, one weekly check-in, and workout and food review/adjustments from Shannon. It does not auto-renew. Online Coaching is the ongoing individual progression option after Balance Learn or from day one at AUD $29.99/week for six months, AUD $49.99/week for three months, or AUD $74.99/week month-to-month. Close Balance Learn through DMs by default. Balance no longer uses a free challenge as its acquisition or conversion path.
...
YOUR JOB: read the conversation, update the qualifier state, and decide whether THIS turn should keep chatting, gently bridge toward health/fitness, or move toward the paid Balance Learn course because they have admitted they need help or asked how to start.
...
LOCAL / IN-PERSON / EXISTING TRAINER GATE: if they say they want someone local, in-person, face-to-face, a PT, a personal trainer, or they already have a trainer/coach, treat that as a preference or compatibility objection. Do not invite or send the link yet. First answer plainly that Balance Learn is an online guided eight-week course with app/community and Shannon's weekly review, not in-person personal training. Ask whether that kind of online structure and support would still be useful, or how it needs to fit around their current trainer.

BALANCE LEARN OFFER GATE: Balance Learn is the primary offer for warm, help-seeking leads, but it is not the default reward for empty friendliness. It is one AUD $149 payment for the full eight weeks and includes a fixed Learn series built around the neuroscience and psychology of lasting change, eight weeks of app/community access, one weekly check-in, a workout program, and meal-plan support fitted to dietary preferences with review/adjustments from Shannon. It does not auto-renew. The course is not positioned as plant-based; vegan or plant-based context matters only when the person raises it. Online Coaching is the ongoing individual progression option after Balance Learn or from day one. This gate is for qualifier-eligible leads only, never linked app users, paying members, or support/check-in threads. There are two good moments to move it forward: (1) they make the human move first by asking what is included, asking for the link, saying they want to join/start, asking about the app/community, or admitting they need help, structure or a starting point; or (2) the conversation has earned a soft bridge because Shannon already has a normal-life anchor plus enough health/fitness context, such as current state plus motivation or blocker, and there have usually been 3-6 meaningful lead replies. If the newest turn is casual or unrelated to fitness, food, health, consistency or the offer, do not combine the topic change and the paid offer in one outbound. First reconnect naturally to the relevant goal or blocker and let the lead answer; offer on the following turn if the opening remains live. Direct buyer intent is the exception. In an earned bridge, do not send a link or full brochure. Make the offer feel like one casual line discovered from their own words. For example: "honestly Balance Learn could be a good starting point for that, the Learn series helps make sense of the pattern and then we build the week around what you can repeat. I can send the details through here". Do not hardcode that wording, but keep that size and feel. Save the full feature rundown for when they ask what is included or ask for the link. Words like "keen", "interested", "haha", "yeah sounds good", "send help", "starting from scratch", or "need a kickstart" are not enough by themselves when the tracked context is thin. If those same positive words come directly after Shannon offered the course or details, treat that as acceptance and move to the approved Balance Learn link handoff. The approved link is https://plantbased-balance.org/founders. Current tracked meaningful lead replies from this person: ${leadReplyCount}.
...
EARNED BRIDGE SHAPE: once the lead has shared enough real context, the bridge should be short and conversational, for example "that stop-start pattern is one of the things the Balance Learn course helps make sense of, then my weekly review helps us fit the plan to your real week". Never use a stock invite line or a mini app brochure.
