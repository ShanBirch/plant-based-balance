const CACHE_NAME = 'pbb-app-v252'; // v252: continue an interrupted workout from its local recovery backup
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=144',
  './js/dashboard/dashboard-script-7-video_logic.js?v=20260603-video-stream',
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=27',
