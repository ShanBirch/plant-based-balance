...
This is why taking breaks isn't catastrophic. Your previous training created lasting changes that make comebacks faster.`,
    ...
    games: [
      ...
      {
        type: GAME_TYPES.SWIPE_TRUE_FALSE,
        question: "Taking a long break from training means all your progress is permanently lost.",
        answer: false,
        explanation: "The nuclei you gained from training remain. This 'muscle memory' means you can regain lost muscle much faster than you built it originally.",
      },
      {
        type: GAME_TYPES.SCENARIO_STORY,
...
Understanding energy balance lets you deliberately choose what you're optimizing for.`,
    ...
    games: [
      ...
      {
        type: GAME_TYPES.SCENARIO_STORY,
        scenario: "Someone wants to lose fat while building muscle at the same time ('body recomposition').",
        question: "Is this possible?",
        options: [
          { text: "No—you must choose one goal", correct: false },
          { text: "Yes, but it's slower—requires slight deficit, high protein, and resistance training", correct: true },
          { text: "Only with special supplements", correct: false },
        ],
        explanation: "Body recomposition is possible, especially for beginners and people returning to training. It's slower than focusing on one goal but allows simultaneous fat loss and muscle gain.",
      },
    ],
  },
  {
