...
- title_source: `compositions/frames/02-workout-title.html`
- source: `compositions/frames/03b-coached-exercise.html`
- title_timing: 5.0-6.8s
- timing: 6.8-13.4s
- title_card: hold “YOUR WORKOUT PROGRAM” clearly before the product animation begins.
- proof: Shannon's real exercise demonstration pulls back into the program view with sets, reps, rest and cues.
- copy: “YOUR WORKOUT PROGRAM”, “BUILT AROUND YOU”, and “Watch it. Learn it. Follow your plan.”

## Frame 3 - Your plant-based meal plan

- title_source: `compositions/frames/03-meal-title.html`
- source: `compositions/frames/03-meal-plan-delivered.html`
- title_timing: 13.1-14.9s
- timing: 14.9-22.4s
- title_card: hold “YOUR PLANT-BASED MEAL PLAN” clearly before the product animation begins.
- proof: meal cards build into a practical weekly plan and grocery list.
- copy: “YOUR PLANT-BASED MEAL PLAN” and “Plan. Shop. Cook. Done.”
