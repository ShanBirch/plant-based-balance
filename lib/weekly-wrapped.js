...
(function(){
  ...
  function buildChallengeReel(){
    return [
      ...
      { bg: 'ww-bg-pbs', hold_ms: 3800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-halftone"></div>
        <div class="ww-kicker" style="color:#1a0a00;">We're giving away</div>
        <div class="ww-big-num" style="font-size: clamp(4.5rem, 22vw, 11rem); color:#1a0a00; line-height:1; text-shadow: 5px 5px 0 #fff, 10px 10px 0 rgba(255,255,255,0.45);">$500</div>
        <div class="ww-caption" style="color:#1a0a00; font-weight:800; margin-top:12px;">cash. No catch.</div>
      `},
      // 2. FREE to enter
      { bg: 'ww-bg-intro', hold_ms: 3500, html: `
        <div class="ww-halftone"></div>
      ...
      `},
      // 3. RULES — 30 days, most XP
      { bg: 'ww-bg-xp', hold_ms: 4600, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">The rules are simple</div>
        <div class="ww-big-num" style="font-size: clamp(4rem, 18vw, 9rem); line-height:1;">30<br>DAYS</div>
        <div class="ww-caption" style="margin-top:14px;">Most <strong>XP gained</strong> wins. That's it.</div>
      `},
      // 4. WAYS TO EARN XP
      { bg: 'ww-bg-workouts', hold_ms: 5000, html: `
        <div class="ww-halftone"></div>
      ...
      { bg: 'ww-bg-social', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        ...
        <div style="display:flex; flex-direction:column; gap:8px; margin-top:14px; width:min(320px, 82vw); font-family:'Inter',sans-serif; font-weight:800;">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.85); color:#1a0a00; padding:8px 14px; border:3px solid #000; border-radius:10px; box-shadow:4px 4px 0 #000; font-size:0.85rem;"><span>… YOU?</span><span>__,___ XP</span></div>
        </div>
      `},
      // 6. STAKES — winner takes all
      { bg: 'ww-bg-pbs', hold_ms: 4500, html: `
        <div class="ww-halftone"></div>
        <div class="ww-kicker" style="color:#1a0a00;">Top of the board after 30 days</div>
        <div class="ww-big-num" style="font-size: clamp(4rem, 20vw, 10rem); color:#1a0a00; text-shadow: 4px 4px 0 #fff;">💸</div>
        <div class="ww-caption" style="color:#1a0a00; font-weight:800;">walks away with <strong>$500 cash</strong>.</div>
        <div class="ww-stamp gold" style="margin-top:18px;">WINNER TAKES ALL</div>
      `},
      // 7. URGENCY — get started now
      { bg: 'ww-bg-streak', hold_ms: 4500, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Challenge starts when</div>
        <div class="ww-big-num" style="font-size: clamp(3rem, 13vw, 6.2rem); line-height:1.05;">YOU<br>DOWNLOAD.</div>
        <div class="ww-caption" style="margin-top:12px;">Every day you wait = XP you'll never catch up.</div>
        <div class="ww-flame" style="margin-top:14px; font-size: clamp(3rem, 11vw, 5rem);">🔥</div>
      `},
      ...
      { bg: 'ww-bg-intro', hold_ms: 8500, html: `
        ...
        <div class="ww-caption" style="font-size:0.95rem; margin-top:4px; opacity:0.92;">Fitness Gamified · $500 XP Challenge</div>
        <div style="display:flex; gap:10px; margin-top:22px; flex-wrap:wrap; justify-content:center;">
          <div class="ww-store-pill">📱 App Store</div>
          <div class="ww-store-pill">▶ Google Play</div>
        </div>
        <div class="ww-stamp gold" style="margin-top:20px;">DOWNLOAD + PLAY FREE</div>
  ...
  const REELS = {
    ...
    'challenge': { name: '$500 XP Challenge', emoji: '💸', theme: 'trap',      build: buildChallengeReel, needsFitgotchi: false },
