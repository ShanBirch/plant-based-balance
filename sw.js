const CACHE_NAME = 'pbb-app-v357-checkout-email-price'; // v357: prefill paid preview email and charge the exact advertised AU$89.99
...
const ASSETS = [
  ...
  './lib/meta-ad-trial.js?v=11-email-and-exact-price',
