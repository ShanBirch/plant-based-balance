...
assert.ok(dashboard.includes('dashboard-script-10-points_widget_functions.js?v=57-ten-workout-styles'), 'phones must load the new share composer');
...
assert.ok(serviceWorker.includes("const CACHE_NAME = 'pbb-app-v463-ten-workout-styles'"), 'the app shell cache must be refreshed');
assert.ok(serviceWorker.includes('dashboard-script-10-points_widget_functions.js?v=57-ten-workout-styles'), 'the new share composer must be precached');
