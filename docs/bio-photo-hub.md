...
Wide-screen photo follow-up: removed the desktop and landscape `object-fit: contain` rules that exposed side bars. Every photo now fills the panel with `cover`; wide-view focal points favour the upper portrait area. The overlay masthead and shared drawer are unchanged. Verified all five photos at phone, landscape and desktop sizes alongside the existing menu/safe-area checks.
