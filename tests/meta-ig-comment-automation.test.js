...
assert.strictEqual(
    leadContext.next_step.includes('normal Vegan Fitness Founders Pass DM path'),
    true,
    'lead context should tell the AI this belongs in the Vegan Fitness Founders Pass DM path'
);
