      ...
      <div style="background: white; border-radius: 20px; padding: 25px; width: 100%; max-width: 320px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        ${result?.is_new_lesson === false ? `
          <div style="padding: 12px; background: #fef3c7; border-radius: 10px; font-size: 0.85rem; color: #92400e;">
            You've already completed this lesson. No additional XP awarded.
          </div>
        ` : ''}
      </div>

      <!-- Action Button -->
      <button onclick="openLearningUnit('${lesson.unitId}')" style="margin-top: 30px; background: white; color: ${module.color}; border: none; padding: 16px 40px; border-radius: 30px; font-size: 1.1rem; font-weight: 700; cursor: pointer; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        Continue Learning
      </button>
    </div>
  `;
