(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.pbb-wci-close{width:44px;height:44px;border:none;border-radius:999px;background:rgba(255,255,255,.10);color:#fff;font-size:1.35rem;line-height:1;display:flex;align-items:center;justify-content:center;cursor:pointer;flex:0 0 auto;}',
      ...
      '.pbb-wci-form{display:grid;gap:20px;font-family:\'Inter\',sans-serif;}',
      ...
      '.pbb-wci-form [data-learn-report]{display:grid;gap:18px;min-width:0;}',
      '.pbb-wci-form [data-learn-report]>h3,.pbb-wci-form [data-learn-report]>p{margin:0;}',
      '.pbb-wci-field{display:grid;gap:10px;min-width:0;}',
