...
const BALANCE_FOUNDATIONS_APP_PROOF_VIDEO_URL = 'https://plantbased-balance.org/assets/balance-learn-dm-149-v17-community.mp4';
const BALANCE_LEARN_STANDARD_VIDEO_URL = 'https://plantbased-balance.org/assets/balance-learn-dm-450-v17-community.mp4';
...
function isBalanceFoundationsAppProofVideoUrl(value = '') {
    ...
    return ['https://plantbased-balance.org/assets/balance-learn-dm-149-v16-checkin.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v16-checkin.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v15-typewriter.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v15-typewriter.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v14-energy-context.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v14-energy-context.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v13-polished-cards.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v11.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v11.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v12-eight-weeks.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v12-eight-weeks.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v10.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v10.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v9.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v9.mp4', BALANCE_FOUNDATIONS_APP_PROOF_VIDEO_URL, BALANCE_LEARN_STANDARD_VIDEO_URL, BALANCE_FOUNDATIONS_THIS_WEEK_VIDEO_URL, BALANCE_LEGACY_SOCIAL_VIDEO_URL]
...
function resolveBalanceFoundationsAppProofVideoUrl(nowMs = Date.now()) {
    ...
    if (Number.isFinite(timestamp) && timestamp >= BALANCE_LEARN_STANDARD_START_MS) return BALANCE_LEARN_STANDARD_VIDEO_URL;
...
function resolvePaidMetaProofVideoAttachmentUrl(value = '', nowMs = Date.now()) {
    const url = String(value || '').trim();
    return isBalanceFoundationsAppProofVideoUrl(url) ? resolveBalanceFoundationsAppProofVideoUrl(nowMs) : url;
}

function resolveBalanceLearnCoursePriceLabel(nowMs = Date.now()) {
    return Number(nowMs) >= BALANCE_LEARN_STANDARD_START_MS ? '$450' : '$149';
}

function stripPaidMetaProofMediaUrls(text = '') {
    const raw = String(text || '');
    const escapedUrls = ['https://plantbased-balance.org/assets/balance-learn-dm-149-v16-checkin.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v16-checkin.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v15-typewriter.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v15-typewriter.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v14-energy-context.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v14-energy-context.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v13-polished-cards.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v11.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v11.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v12-eight-weeks.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v12-eight-weeks.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v10.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v10.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-149-v9.mp4', 'https://plantbased-balance.org/assets/balance-learn-dm-450-v9.mp4', BALANCE_FOUNDATIONS_APP_PROOF_VIDEO_URL, BALANCE_LEARN_STANDARD_VIDEO_URL, BALANCE_FOUNDATIONS_THIS_WEEK_VIDEO_URL, BALANCE_LEGACY_SOCIAL_VIDEO_URL]
...
module.exports = {
    ...
    BALANCE_LEARN_STANDARD_VIDEO_URL,
    BALANCE_LEARN_STANDARD_START_MS,
