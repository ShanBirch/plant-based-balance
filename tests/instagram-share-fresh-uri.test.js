...
assert.ok(
    dashboard.includes('dashboard-script-10-points_widget_functions.js?v=41') &&
        serviceWorker.includes("const CACHE_NAME = 'pbb-app-v271'") &&
        serviceWorker.includes('./js/dashboard/dashboard-script-10-points_widget_functions.js?v=41'),
