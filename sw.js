const CACHE_NAME = 'pbb-app-v309'; // v309: refresh Home activity review and daily steps progress
...
'./js/dashboard/pbb-deferred-weeklygoals.js?v=31',
  ...
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=44',
