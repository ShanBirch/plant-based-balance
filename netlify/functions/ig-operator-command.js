...
`;
    ...
    if (!ideas.length) {
        ideas = [{
            ...
            cta: 'Reply "balance" if you want the Plant-Based Fitness Founders Pass details.',
        ...
        ideas = [
            {
                ...
                cta: 'Reply "balance" and I will send the Plant-Based Fitness Founders Pass details.',
            },
            {
                type: 'story',
