...
(function(){
  ...
  function buildAskConditioningReel(){
    ...
    return [
      ...
      // ── THE DEEPER CATCH — you can't even "decide" to do the methods ─
      ...
      twLine('gpt',  'You can only <strong>learn to want</strong>.',                         { speed: SLOW, pause: 1300 }),
      twLine('gpt',  'Every new input — a video, a book, a conversation, a tough day —',   { speed: NORM, pause: 800 }),
      twLine('gpt',  'feeds the engine new data.',                                          { speed: NORM, pause: 900 }),
      twLine('gpt',  'Slowly, it starts predicting differently.',                           { speed: NORM, pause: 900 }),
      twLine('gpt',  'One day, on its own, it\'ll <em>want</em> something new.',             { speed: SLOW, pause: 1200 }),
      twLine('gpt',  'And <em>then</em> the other two follow naturally.',                    { speed: SLOW, pause: 1400 }),
