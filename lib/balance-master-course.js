...
(function () {
    ...
    function current() { if (owner !== uid()) { owner = uid(); state = null; loadPromise = null; templates = []; submissions = {}; submissionError = ""; } return state || blank(); }
    ...
    function event(name, extra = {}) { context?.track?.(`master_${name}`, { stage: stageIndex + 1, curriculum_version: 'balance_master_v1', form_check_requirement: 'master_compound_video_v1', ...extra }); }
