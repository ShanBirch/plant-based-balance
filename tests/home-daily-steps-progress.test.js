...
test('versioned phone assets advance for the Home fix', () => {
  ...
  assert.match(dashboard, /pbb-next-obvious-steps\.js\?v=30-home-guided-tour/);
  ...
  assert.match(serviceWorker, /const CACHE_NAME = 'pbb-app-v374-first-week-checkin-gate'/);
