        ...
        'body-1': [
            {
                ...
                content: {
                    intro: `Muscles do one thing: they contract (shorten). They pull, never push.

When you "push" a door, your muscles are actually pulling your bones to create that pushing motion. Every movement you make—walking, lifting, breathing, even blinking—happens because muscles contract and pull.

Here's how it works: Your brain sends a signal through your nerves. The muscle fibers receive that signal and contract (shorten). The muscle pulls on the tendon (which attaches muscle to bone), the tendon pulls on the bone, and the joint moves.

Your heart is also a muscle—cardiac muscle that contracts rhythmically to pump blood. Muscles are everywhere, powering everything your body does.`,
                    keyPoint: "Muscles can only pull by contracting. They attach to bones via tendons, and every movement requires this pull.",
                },
                games: [
...
Common opposing pairs include:
• Biceps & Triceps (bend and straighten your elbow)
• Quadriceps & Hamstrings (straighten and bend your knee)
• Chest & Back (push and pull movements)
• Hip flexors & Glutes (lift leg forward and extend it back)

When one muscle contracts, its opposing muscle must relax. This is called reciprocal inhibition—your nervous system automatically coordinates this. When your brain signals your biceps to contract, it simultaneously inhibits your triceps so it relaxes.

This coordinated dance happens automatically thousands of times per day without you thinking about it.`,
                    keyPoint: "Muscles work in opposing pairs—when one contracts, the other relaxes (reciprocal inhibition)—to move joints in both directions.",
                },
                games: [
...
Slow-twitch (Type I): Fatigue-resistant and efficient at using oxygen. Great for endurance activities like walking, jogging, and marathon running. They produce less force but can keep going for a long time.

Fast-twitch (Type II): Produce more force but tire quickly. Great for explosive movements like sprinting, jumping, and heavy lifting. They're powerful but run out of steam fast.

Marathon runners tend to have more slow-twitch fibers. Sprinters tend to have more fast-twitch fibers. Everyone has both types, but your baseline ratio is largely genetic.

The good news: training can shift some fibers. Endurance training develops your slow-twitch fibers; power and strength training develops your fast-twitch fibers.`,
                    keyPoint: "Slow-twitch fibers are fatigue-resistant for endurance; fast-twitch produce more force for power. Training can develop each type.",
                },
                games: [
...
Training creates microscopic damage to muscle fibers. During recovery, your body repairs these fibers and adds a bit extra—making them slightly bigger and stronger. This is why muscles grow during rest, not during the workout itself.

Three things are essential for muscle growth:
• Progressive overload: Gradually increasing the challenge (more weight, reps, or sets)
• Adequate protein: The building blocks your body uses to rebuild muscle fibers
• Sufficient sleep: When most repair and growth actually happens

Important: Soreness is NOT required for muscle growth. You can build muscle without being sore after every workout. Soreness just means you did something your body wasn't used to.

If you stop challenging your muscles (no progressive overload), they stop adapting and growing.`,
                    keyPoint: "Muscles grow during recovery, not during workouts. You need progressive overload, protein, and sleep.",
                },
                games: [
            ...
            },
            {
                ...
                content: {
                    intro: `Your body is efficient—it won't maintain muscle it doesn't need. Muscle is metabolically expensive, so your body conserves energy by only keeping what's being used.

Without regular challenge, muscles atrophy (shrink). Here's what happens:
• Muscle fibers shrink in size
• Strength decreases
• Your body conserves resources it was using to maintain that muscle

This happens faster than you might think—just two weeks of inactivity can begin measurable muscle loss.

The good news? Muscle memory is real. When you train, your muscle cells gain extra nuclei. Even after you stop training and lose size, those extra nuclei remain. This means previously trained muscles rebuild much faster than muscles that were never trained—even after years off.

So don't fear breaks. Your body remembers.`,
                    keyPoint: "Muscles atrophy without use as your body conserves resources. But muscle memory means you'll rebuild faster after breaks.",
                },
                games: [
