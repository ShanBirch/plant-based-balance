    ...
    if (d.streak > 0) {
      slides.push({
        ...
        html: `
          ...
          <div class="ww-big-num" style="font-size: clamp(3.5rem, 14vw, 7rem); margin-top:14px;">${d.streak}</div>
    ...
    if (d.goals && d.goals.total > 0) {
      ...
      slides.push({
        ...
        html: `
          ...
          <div class="ww-caption" style="margin-bottom:12px;">weekly goals hit this month</div>
