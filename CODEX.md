...
- Scheduled Story nurturing runs five times daily with a base target of five verified replies. Select the next-best eligible relationship from the ranked Story queue first, then visit that person's profile and check for a live Story; do not start from random Story-tray discovery. A Story reply is rapport-first and never a blind pitch.
