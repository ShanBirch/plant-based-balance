...
const BALANCE_CHECKOUT_PLANS = Object.freeze({
    balance_learn_weekly: Object.freeze({
        ...
        commitmentWeeks: 6, commitmentLabel: "6-week initial minimum",
        renewalTerms: "continues_weekly_after_six_week_minimum",
        cancellationNoticeDays: 0,
        checkoutDisclosure: "AUD $24.83 today and every week, with a six-week minimum (six payments; AUD $148.98 minimum total). After six weeks, cancel any time before your next weekly payment. Access continues through your paid period. No additional notice period. Same weekly coaching support throughout.",
...
export function getPublicCheckoutOffer(priceId) {
    ...
    return Object.freeze({
        ...
        commitmentWeeks: plan.commitmentWeeks || null,
