...
(function (root, factory) {
    ...
    function renderFoundationsOffer(offer) {
        ...
        const copy = weekly ? 'AUD $24.83 a week for 6 weeks ($148.98 total), then AUD $99.32 every 4 weeks. Same weekly check-in, workout and food review, app and community access. Cancel before your next payment; access continues through your paid period.' : 'One ' + formatted + ' payment for the full six weeks. No subscription or automatic renewal.';
        if (priceCopy) priceCopy.textContent = weekly ? 'AUD $24.83 a week for 6 weeks ($148.98 total), then AUD $99.32 every 4 weeks.' : copy;
    ...
    function checkoutCompliance(email) {
        ...
        return {
            ...
            document_versions: {
                terms: '2026-09-08', privacy: '2026-05-19',
                client_agreement: '2026-09-08', refund_policy: '2026-09-08'
            },
            profile: profile,
