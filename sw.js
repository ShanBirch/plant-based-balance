const CACHE_NAME = 'pbb-app-v349-guided-researcher-lesson'; // v349: read-first researcher lesson with unobstructed course controls
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=196-fresh-meta-meals',
