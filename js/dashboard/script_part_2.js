...
_chainLoad('lib/auth-guard.js?v=12-light-launch', 'scripts_auth_guard_loaded', 0, function() {
...
document.write('<script src="lib/auth-guard.js?v=12-light-launch"><\/script>');
