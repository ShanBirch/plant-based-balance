const CACHE_NAME = 'pbb-app-v490-locked-share-photo'; // v490: keep the specialist heading update and lock share backgrounds while restoring editor controls
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=62-locked-photo-text-tools',
