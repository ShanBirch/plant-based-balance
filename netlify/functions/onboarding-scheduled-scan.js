...
const MILESTONES = [
    ...
    {
        days: 49,
        alertType: 'foundations_day_49_review',
        priority: 'high',
        title: (name) => `${name} — Balance Learn week 7 review`,
        lengthBrief: '2-4 sentences',
        windowLabel: 'SEVEN WEEKS',
        windowMs: 49 * 24 * 60 * 60 * 1000,
        requiredPlan: 'balance_foundations_six_week',
        requiresNeedsYou: true,
        instructions: `This is the personal week-seven review for a Balance Learn member. Recognise specific progress, name the strongest useful pattern Shannon has seen, and set one clear focus for the final week. Do not sell yet. Ask one short question that helps Shannon decide whether self-directed app access or ongoing Online Coaching will suit them after week eight.`,
    },
    {
        days: 56,
        alertType: 'foundations_day_56_next_step',
        priority: 'urgent',
        title: (name) => `${name} — Balance Learn completion and next step`,
        lengthBrief: '3-5 sentences',
        windowLabel: 'EIGHT WEEKS',
        windowMs: 56 * 24 * 60 * 60 * 1000,
        requiredPlan: 'balance_foundations_six_week',
        requiresNeedsYou: true,
        instructions: `This is the end of their included eight-week Balance Learn block. Celebrate specific progress and briefly explain that the included course access and weekly support are ending. Recommend ONE next step based on their behaviour: App + Community at AUD $19.99/month if they are ready to continue self-directed, or Online Coaching if they want Shannon to keep reviewing and adjusting their plan weekly. Online Coaching is AUD $29.99/week for six months, AUD $49.99/week for three months, or AUD $74.99/week month-to-month. Keep it personal and low pressure. Do not imply automatic renewal.`,
    },
];
