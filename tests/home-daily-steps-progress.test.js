...
test('versioned phone assets advance for the Home fix', () => {
  ...
  assert.match(dashboard, /pbb-next-obvious-steps\.js\?v=31-checklist-guided-tour/);
  ...
  assert.match(serviceWorker, /const CACHE_NAME = 'pbb-app-v379-checklist-guided-tour'/);
