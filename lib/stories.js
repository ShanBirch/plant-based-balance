...
window.renderFridayWeighInCard = function(cardData) {
    ...
    const sharePointsRaw = Number(cardData.share_points_available);
    const sharePoints = Number.isFinite(sharePointsRaw) && sharePointsRaw > 0 ? Math.round(sharePointsRaw) : 10;
