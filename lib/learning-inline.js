        ...
        'mind-6': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "What actually happens when you 'resist' temptation?", items: ["Environmental cue triggers a prediction (eat the cookie)", "A competing higher-level prediction fires (I eat healthy)", "Context determines which prediction has more weight", "The stronger prediction drives your behavior", "You experience this as 'willpower' or 'giving in'"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "What actually happens when you 'decide' something?", items: ["Context activates relevant predictions", "Brain weighs competing predictions", "Strongest prediction drives action", "You become aware of the result", "You experience it as a 'choice'"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How did your current habits form?", items: ["You were immersed in an environment", "Brain tracked repeated patterns", "Predictions built automatically", "Behaviors became habitual", "You assumed 'this is just who I am'"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to redesign your system:", items: ["Identify the behavior you want to change", "Find the friction points", "Reduce friction for desired behavior", "Increase friction for unwanted behavior", "Let your predictive brain automate the rest"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does social environment change you?", items: ["You immerse in a new social context", "Brain observes 'what people here do'", "Your prediction of 'normal' recalibrates", "New behaviors feel natural, not forced", "You change without 'deciding' to change"]},
        ...
        'mind-7': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does the prediction cycle work?", items: ["Brain generates a prediction", "Sensory data arrives from the world", "Brain compares prediction to data", "Any mismatch creates a prediction error", "Brain acts to minimize the error"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does active inference work?", items: ["Brain predicts a state (e.g. warm body)", "Sensory signals don't match (you feel cold)", "Brain generates an action plan", "You act (put on sweater)", "Sensory signals now match the prediction"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does context shift precision?", items: ["You have competing predictions (eat healthy vs. eat comfort food)", "Context changes (you're exhausted and stressed)", "Precision shifts to immediate, lower-level prediction", "The comfort food prediction now dominates", "You act on the high-precision prediction"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does allostasis work?", items: ["Brain forecasts an upcoming metabolic need", "Brain prepares resources in advance", "Body state adjusts before need arises", "Need is met smoothly", "Surprise is minimized"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does the coupled system create change?", items: ["You change something in your environment", "New environmental data reaches your brain", "Brain updates its predictions automatically", "New predictions drive new behaviors", "New behaviors further shape the environment"]},
        ...
        'mind-8': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Why the brain resists learning:", items: ["Surprise creates a prediction error", "Prediction error requires model update", "Model update costs metabolic energy", "Brain prefers to conserve energy", "Brain avoids surprise whenever possible"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How confirmation bias actually works:", items: ["Brain holds a prediction (belief)", "New information arrives", "Brain checks: does this confirm or disconfirm?", "Confirming info is absorbed cheaply", "Disconfirming info is discounted or ignored"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How beliefs become self-fulfilling:", items: ["Brain holds a prediction (belief)", "Prediction shapes what you notice", "What you notice shapes your experience", "Experience 'confirms' the prediction", "Prediction strengthens further"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Why facts don't change minds:", items: ["New information arrives that contradicts a belief", "Brain detects incoming prediction error", "Prediction error would require expensive model update", "Brain deploys cost-avoidance strategy", "Information is rejected—energy conserved"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to make learning affordable:", items: ["Identify the change you want", "Break it into the smallest possible step", "Introduce one small prediction error", "Brain processes the affordable update", "Repeat with next small step"]},
        ...
        'fuel-6': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does a craving form?", items: ["Body budget runs low (stress, fatigue, etc.)", "Brain generates unpleasant feelings", "Brain searches for predicted fix", "Past experience: sugar helped before", "You experience the prediction as a craving"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does the brain create 'hunger'?", items: ["Body sends raw interoceptive signals", "Brain receives ambiguous data", "Brain checks context and past experience", "Brain generates a prediction: 'this is hunger'", "You experience the prediction as the feeling of hunger"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Why comfort food cravings cycle:", items: ["Body budget deficit (from stress, poor sleep, etc.)", "Brain predicts sugar/fat will help", "You eat comfort food—it genuinely helps briefly", "Underlying deficit remains (food can't fix it)", "Craving returns 30 minutes later"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How granularity changes your response to cravings:", items: ["Body budget signal arrives (you feel 'bad')", "Instead of defaulting to 'hungry,' you pause", "You check: am I tired? lonely? stressed? actually hungry?", "You identify the specific need", "You address that need directly"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to actually resolve chronic cravings:", items: ["Recognize cravings signal a body budget deficit", "Identify what's draining the budget (sleep? stress? isolation?)", "Address the actual deficits directly", "Budget begins to balance", "Cravings reduce because the underlying need is met"]},
        ...
        'fuel-7': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.TAP_ALL, question: "When might supplements be genuinely useful?", options: [
                        ...
                        { text: "Plant-based diet (B12)", correct: true },
                    ]},
            ...
            {
                id: 'fuel-7-2', unitId: 'fuel-7', order: 2, title: "Plant-Based Vitamin Essentials",
                content: {
                    intro: `On a plant-based diet, certain vitamins need extra attention:\n\nVitamin B12: Not found in plant foods. Supplementation is essential—no exceptions.\nVitamin D: Hard to get from any diet. Sunlight is the primary source, but supplementation often needed.\nOmega-3 (DHA/EPA): Plant sources provide ALA, but conversion to DHA/EPA is low. Algae-based supplements are the plant-based solution.\n\nIron and zinc are available in plants but less bioavailable. Pairing iron-rich foods with vitamin C dramatically boosts absorption.`,
                    keyPoint: "B12 supplementation is non-negotiable on a plant-based diet. Vitamin D and algae-based omega-3 are also commonly needed.",
                },
                games: [
                    { type: GAME_TYPES.TAP_ALL, question: "Which nutrients need special attention on a plant-based diet?", options: [
                        { text: "Vitamin B12", correct: true },
                        { text: "Vitamin D", correct: true },
                        { text: "Omega-3 DHA/EPA", correct: true },
                        { text: "Vitamin C", correct: false },
                        { text: "Iron", correct: true },
                    ]},
                    { type: GAME_TYPES.FILL_BLANK, sentence: "Vitamin _______ is not found in plant foods and must be supplemented.", options: ['B12', 'C', 'A', 'K'], answer: 'B12' },
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        { left: "B12", right: "Must supplement on plant-based diet" },
                        { left: "Vitamin D", right: "Sunlight is primary source" },
                        { left: "DHA/EPA", right: "Algae-based supplement" },
                        { left: "Iron absorption", right: "Boosted by vitamin C" },
                    ]},
                    { type: GAME_TYPES.SCENARIO_STORY, scenario: "Someone has been plant-based for 2 years without any B12 supplementation. They feel increasingly fatigued and have tingling in their hands.", question: "What's likely happening?", options: [
                        { text: "They need more protein", correct: false },
                        { text: "B12 deficiency—which can cause nerve damage if untreated", correct: true },
                        { text: "They should eat more carbs", correct: false },
                    ], explanation: "B12 stores can last 2-3 years, but deficiency causes irreversible nerve damage. Supplementation is non-negotiable on a plant-based diet." },
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "You can get enough B12 from unwashed vegetables and fermented foods.", answer: false, explanation: "These sources are unreliable. B12 supplementation is the only reliable way to ensure adequate intake on a plant-based diet." },
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to boost iron absorption from plant foods:", items: ["Choose iron-rich plant foods (lentils, spinach, tofu)", "Pair with vitamin C source", "Avoid tea or coffee with the meal", "Vitamin C dramatically increases absorption", "Meet iron needs without supplements"]},
                    { type: GAME_TYPES.TAP_ALL, question: "What are good plant-based sources of omega-3 ALA?", options: [
                        { text: "Flaxseeds", correct: true },
                        { text: "Chia seeds", correct: true },
                        { text: "Walnuts", correct: true },
                        { text: "White rice", correct: false },
                        { text: "Hemp seeds", correct: true },
                    ]},
                    { type: GAME_TYPES.FILL_BLANK, sentence: "Algae-based supplements provide _______ and EPA directly, without the fish.", options: ['DHA', 'ALA', 'B12', 'iron'], answer: 'DHA' },
                ]
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to evaluate a supplement:", items: ["Check for third-party testing (USP/NSF)", "Review the ingredient forms", "Check dosages against Daily Values", "Look for red flags (proprietary blends)", "Research if the claims are evidence-based"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Rank these by strength of scientific evidence (strongest first):", items: ["Vitamin B12 for plant-based diets", "Creatine for strength and cognition", "Magnesium if deficient", "Protein powder for convenience", "Fat burners for weight loss"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.TAP_ALL, question: "What's commonly recommended for plant-based eaters?", options: [
                        { text: "Vitamin B12", correct: true },
                        { text: "Vitamin D", correct: true },
                        { text: "Algae-based omega-3", correct: true },
                    ...
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "A basic plant-based supplement stack is B12, Vitamin D, and optionally algae omega-3.", answer: true, explanation: "These three address the most common gaps in a plant-based diet. Everything else should be based on individual blood work." },
        ...
        'fuel-8': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.TAP_ALL, question: "Which statements are MYTHS?", options: [
                        ...
                        { text: "B12 is essential for plant-based diets", correct: false },
                    ]},
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "From most to least important for supplement safety:", items: ["Third-party testing and certification", "Appropriate dosage for your needs", "Bioavailable form of the nutrient", "Brand reputation", "Whether it's 'natural' or synthetic"]},
            ...
            },
            {
                ...
                content: {
                    intro: `Can you match vitamins and minerals to their best plant-based food sources?\n\nKnowing where nutrients come from helps you eat strategically without relying heavily on supplements.\n\nExamples: Iron comes from lentils and spinach. Calcium from fortified plant milk and kale. Zinc from pumpkin seeds and chickpeas. Omega-3 ALA from flaxseeds and walnuts.\n\nThe more diverse your plate, the fewer supplements you need.`,
                    keyPoint: "Knowing plant-based food sources for key nutrients reduces supplement dependence. Diversity on your plate = diversity in your nutrients.",
                },
                games: [
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        { left: "Iron", right: "Lentils and spinach" },
                        { left: "Calcium", right: "Fortified plant milk and kale" },
                        { left: "Zinc", right: "Pumpkin seeds and chickpeas" },
                        { left: "Omega-3 ALA", right: "Flaxseeds and walnuts" },
                    ]},
                    { type: GAME_TYPES.FILL_BLANK, sentence: "_______ are one of the best plant-based sources of iron.", options: ['Lentils', 'Bananas', 'Apples', 'Rice'], answer: 'Lentils' },
                    { type: GAME_TYPES.TAP_ALL, question: "Which are good plant-based calcium sources?", options: [
                        { text: "Fortified plant milk", correct: true },
                        { text: "Kale", correct: true },
                        { text: "Broccoli", correct: true },
                        { text: "White bread", correct: false },
                        { text: "Tofu (calcium-set)", correct: true },
                    ]},
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        { left: "B12", right: "Fortified foods or supplement" },
                        { left: "Vitamin C", right: "Bell peppers and citrus" },
                        { left: "Vitamin K", right: "Dark leafy greens" },
                        { left: "Iodine", right: "Seaweed and iodized salt" },
                    ]},
                    { type: GAME_TYPES.SCENARIO_STORY, scenario: "You want to increase your iron intake naturally. You eat a bowl of lentil soup.", question: "What should you add to boost iron absorption?", options: [
                    ...
                    ], explanation: "Vitamin C dramatically increases non-heme iron absorption from plant foods. Coffee and tea contain tannins that inhibit iron absorption." },
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "Seaweed is a good plant-based source of iodine.", answer: true, explanation: "Seaweed is one of the richest plant-based sources of iodine. Even small amounts provide significant iodine. Iodized salt is another reliable source." },
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Top plant-based iron sources (highest to lowest):", items: ["Lentils and beans", "Tofu and tempeh", "Spinach and dark greens", "Quinoa and fortified cereals", "Nuts and seeds"]},
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How to evaluate a supplement claim:", items: ["Read the specific claims being made", "Look for cited scientific studies", "Check for third-party testing badges", "Search for independent reviews", "Be skeptical of 'too good to be true' promises"]},
            ...
            },
            {
                ...
                content: {
                    intro: `Final challenge: put it all together and build the ideal supplement strategy for different scenarios.\n\nPlant-based athlete: B12 + Vitamin D + Algae omega-3 + Creatine + Iron (if tested low)\nWinter months: Add or increase Vitamin D\nStress and sleep issues: Consider magnesium glycinate\nPregnancy: Prenatal with folate, iron, DHA, and B12\n\nRemember: test, don't guess. Personalize based on blood work. Quality over quantity. Food always comes first.`,
                    keyPoint: "Build your stack based on your specific needs, diet, and test results. A plant-based athlete's stack differs from a general wellness stack.",
                },
                games: [
                    { type: GAME_TYPES.SCENARIO_STORY, scenario: "A plant-based athlete wants to start supplementing. They train 5 days a week and live in a northern climate. Blood work shows low Vitamin D and borderline B12.", question: "What stack would you recommend?", options: [
                        { text: "Fat burner and testosterone booster", correct: false },
                        { text: "B12, Vitamin D, algae omega-3, and creatine", correct: true },
                        { text: "Just a multivitamin", correct: false },
                    ], explanation: "This covers the confirmed deficiencies (B12, D), provides DHA/EPA plant-based athletes need, and creatine is well-evidenced for performance." },
                    { type: GAME_TYPES.TAP_ALL, question: "What belongs in a basic plant-based supplement stack?", options: [
                        { text: "Vitamin B12", correct: true },
                        { text: "Vitamin D", correct: true },
                        { text: "Algae-based omega-3", correct: true },
                    ...
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        { left: "Plant-based athlete", right: "B12 + D + Omega-3 + Creatine" },
    ...
    games: [
      ...
      },
      {
        ...
        items: [
          ...
          "Elite: Annual periodization with peaks",
        ],
        correctOrder: [0, 1, 2, 3],
      },
      {
...
Training both doesn't mean doing both in equal amounts. Build the aerobic base first; add anaerobic work on top.`,
    ...
    games: [
      ...
      },
      {
        ...
        items: [
          "Establish aerobic base (Zone 2 work)",
          "Develop aerobic capacity (tempo work)",
          "Add anaerobic intervals",
          "Sport-specific high-intensity work",
          "Maintain base while peaking",
        ],
        correctOrder: [0, 1, 2, 3, 4],
      },
      {
    ...
    games: [
      ...
      },
      {
        ...
        items: [
          ...
          "Introduce 1-2 HIIT sessions weekly",
          "Allow recovery between sessions",
          "Balance with LISS work",
...
There's no perfect program—only the one you'll actually do consistently with effort. Start where you are, apply the principles, and trust the process.`,
        ...
        'hormones-1': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does hormone signaling work?", items: ["Gland produces hormone", "Hormone enters bloodstream", "Blood carries hormone throughout body", "Cells with matching receptors receive signal", "Target cells change their behavior"]},
        ...
        'hormones-2': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "What happens during an adrenaline response?", items: ["Brain predicts demanding situation", "Adrenal glands release adrenaline", "Heart rate increases", "Blood redirects to muscles", "Glucose floods into bloodstream"]},
        ...
        'hormones-3': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does growth hormone build muscle?", items: ["Deep sleep or intense exercise occurs", "Pituitary releases growth hormone", "GH travels to liver", "Liver produces IGF-1", "IGF-1 stimulates muscle repair and growth"]},
        ...
        'hormones-4': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "What happens after you eat a meal?", items: ["Food digests, glucose enters blood", "Pancreas detects rising glucose", "Insulin is released", "Cells absorb glucose from blood", "Excess glucose stored as glycogen or fat"]},
        ...
        'hormones-5': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How do lifestyle factors affect sex hormones?", items: ["Chronic stress, poor sleep, or under-eating occurs", "Brain detects unfavorable conditions", "Signals to reproductive axis decrease", "Sex hormone production drops", "Libido, energy, and recovery suffer"]},
                ]
            },
        ],
    };
    ...
    async function completeLesson() {
        ...
        // Daily Quiz Bonus: award +10 XP if this was a daily quiz and lesson completed with 100%
