...
assert(
    ...
    guard.includes('unitAmount: 15000') &&
...
assert(
    ...
    checkout.includes("'founders-pass': { amount: Date.now() < Date.parse('2026-10-09T00:00:00+10:00') ? 15000 : 45000, label: 'Balance Learn', successPlan: 'balance_foundations_six_week' }") &&
