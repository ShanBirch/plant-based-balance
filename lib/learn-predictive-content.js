...
(function(root) {
  ...
  const practice = {
    ...
    'mind-6-5': [
      ...
      ['Which action puts this lesson into practice?', ['Talk to someone outside coaching and arrange a walk together','Wait for their habits to transfer without taking part','Publish their identity in your check-in'],0,'A conversation and shared activity give you a specific experience to learn from.'],
      ['Which check-in best captures the experiment?', ['My friend guarantees I will keep training','I must say it helped even if nothing changed','We discussed walking, went together, and starting felt easier'],2,'Record what you discussed, what you tried and what actually changed. A neutral outcome is useful too.']
    ],
    'mind-4-2': [
