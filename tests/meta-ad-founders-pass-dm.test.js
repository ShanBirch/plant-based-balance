...
test('time-limited Foundations proof resolves in Brisbane campaign time and expires to evergreen', () => {
    ...
    assert.equal(
        BALANCE_FOUNDATIONS_APP_PROOF_VIDEO_URL,
        'https://plantbased-balance.org/assets/balance-learn-dm-149-v18-sharp.mp4'
    );
    const courseFirstAsset = path.join(__dirname, '../assets/balance-learn-dm-149-v18-sharp.mp4');
