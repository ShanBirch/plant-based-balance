...
export const POINTS_CONFIG = {
  ...
  POINTS_PER_ACTIVITY_FEED_SHARE: 5, // 5 points for sharing a tracked walk/run/activity to Feed
  ...
  DAILY_QUIZ_BONUS: 10,         // 10 XP bonus on top of the 5 XP perfect-quiz reward (15 XP total)
