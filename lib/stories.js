...
function renderFeedTextPostCard(story, options = {}) {
    ...
    const headlineFontSize = headlineLength > 95 ? '1.65rem' : headlineLength > 62 ? '1.9rem' : '2.18rem';
    const bodyFontSize = bodyLength > 180 ? '0.86rem' : '0.94rem';
    const shellHeight = isViewer
        ? 'min-height:min(70vh, 560px); max-height:70vh; overflow-y:auto; -webkit-overflow-scrolling:touch;'
    ...
    if (variant === 'reflection') {
        return `
            <div class="feed-text-post-card feed-text-post-card-reflection" style="position:relative; width:100%; ${shellHeight} box-sizing:border-box; overflow:hidden; background:linear-gradient(180deg,#fffdf6 0%,#edf7ed 100%); color:#142017; -webkit-text-fill-color:#142017; --feed-mention-color:#14532d;">
                ...
                <div style="position:relative; min-height:100%; display:flex; flex-direction:column; justify-content:space-between; gap:18px; padding:58px 32px 30px; box-sizing:border-box;">
                    <div>
                        ...
                        <div style="margin:22px 0 12px; font-size:${headlineFontSize}; line-height:1.06; font-weight:950; letter-spacing:0; overflow-wrap:anywhere; word-break:break-word;">${formatFeedText(segments.headline)}</div>
                        ${segments.body ? `<div style="font-size:${bodyFontSize}; line-height:1.38; font-weight:750; color:#3f4c42; -webkit-text-fill-color:#3f4c42; overflow-wrap:anywhere; word-break:break-word; white-space:normal; ${bodyClamp}">${formatFeedText(segments.body)}</div>` : ''}
                    </div>
    ...
    return `
        <div class="feed-text-post-card feed-text-post-card-bold" style="position:relative; width:100%; ${shellHeight} box-sizing:border-box; overflow:hidden; background:linear-gradient(135deg,#052e1b 0%,#14532d 58%,#b8892b 145%); color:white; -webkit-text-fill-color:white; --feed-mention-color:rgba(255,255,255,0.96);">
            ...
            <div style="position:relative; min-height:100%; display:flex; flex-direction:column; justify-content:space-between; gap:18px; padding:27px 24px 24px; box-sizing:border-box;">
                <div>
                    ...
                    <div style="margin:24px 0 12px; font-size:${headlineFontSize}; line-height:1.03; font-weight:950; letter-spacing:0; overflow-wrap:anywhere; word-break:break-word;">${formatFeedText(segments.headline)}</div>
                    ${segments.body ? `<div style="font-size:${bodyFontSize}; line-height:1.36; font-weight:760; color:rgba(255,255,255,0.9); -webkit-text-fill-color:rgba(255,255,255,0.9); overflow-wrap:anywhere; word-break:break-word; white-space:normal; ${bodyClamp}">${formatFeedText(segments.body)}</div>` : ''}
                </div>
