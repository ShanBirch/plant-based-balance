const CACHE_NAME = 'pbb-app-v243'; // v243: let exercise video uploads finish in background; v242: route exercise video uploads through server-side B2 helper
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=128',
