...
function catalogue(now = new Date()) {
  return {
    ...
    gen: {type: 'image', url: 'https://plantbased-balance.org/photos/client-success/gen-cocos.jpg', facts: 'Gen (sometimes spelled Jen by the person asking). Her pictured transformation took two years, confirmed by Shannon on 17 September 2026. Strength, fitness and confidence through progressive repeatable training. No verified weight-loss amount. Answer the timeframe when asked; it is not the six-week Learn course duration or a promised result.'},
    ...
    bec_kirsty: {type: 'image', url: 'https://plantbased-balance.org/photos/client-success/bec-kirsty-cocos.png', facts: 'Shared accountability. Both lost over 10kg and got stronger. Their shared transformation took 12 months (one year), confirmed by Shannon on 17 September 2026. This is distinct from Kristy’s separate 26-week photo. Keep the timeframe available for questions; do not routinely add it to the introduction.'},
