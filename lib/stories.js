...
window.renderNutritionCard = function(cardData) {
    ...
    return `
        <div style="width:100%; aspect-ratio:4/5; background:linear-gradient(160deg, #1e1b4b 0%, #4338ca 30%, #6366f1 60%, #818cf8 100%); display:flex; flex-direction:column; padding:28px 24px; box-sizing:border-box; position:relative; overflow:hidden;">
            ...
            <div style="z-index:1; flex:1; display:flex; flex-direction:column;">
                ...
                <div style="margin-bottom:14px;">
                    ...
                    <div style="font-size:0.7rem; font-weight:800; letter-spacing:3px; text-transform:uppercase; color:rgba(255,255,255,0.7);">Daily Nutrition</div>
                </div>
                ...
                <div style="display:flex; align-items:center; gap:16px; margin-bottom:20px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:0.75rem; color:rgba(255,255,255,0.6); margin-top:2px;">${mealCount} meal${mealCount !== 1 ? 's' : ''} logged</div>
                    </div>
                </div>
                ...
                <div style="background:rgba(255,255,255,0.1); backdrop-filter:blur(8px); border-radius:14px; padding:14px 16px; margin-bottom:14px; border:1px solid rgba(255,255,255,0.1);">
                    <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:6px;">
                        <div style="font-size:0.7rem; color:rgba(255,255,255,0.6); text-transform:uppercase; letter-spacing:1px;">Calories</div>
                        <div style="font-size:0.75rem; color:rgba(255,255,255,0.5);">${calPct}%</div>
                    </div>
                    <div style="display:flex; align-items:baseline; gap:6px;">
                        <div style="font-size:1.5rem; font-weight:800; color:white;">${calories}</div>
                        <div style="font-size:0.8rem; color:rgba(255,255,255,0.5);">/ ${calorieGoal} kcal</div>
                    </div>
                </div>
                ...
                <div style="display:flex; gap:8px; margin-bottom:16px;">
                    <div style="flex:1; background:rgba(255,255,255,0.08); border-radius:10px; padding:10px 12px;">
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.5); margin-bottom:4px;">Protein</div>
                        <div style="font-size:1rem; font-weight:700; color:#60a5fa; margin-bottom:6px;">${protein}g</div>
                        ${macroBar(protein, proteinGoal, '#60a5fa')}
                    </div>
                    <div style="flex:1; background:rgba(255,255,255,0.08); border-radius:10px; padding:10px 12px;">
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.5); margin-bottom:4px;">Carbs</div>
                        <div style="font-size:1rem; font-weight:700; color:#fbbf24; margin-bottom:6px;">${carbs}g</div>
                        ${macroBar(carbs, carbsGoal, '#fbbf24')}
                    </div>
                    <div style="flex:1; background:rgba(255,255,255,0.08); border-radius:10px; padding:10px 12px;">
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.5); margin-bottom:4px;">Fat</div>
...
window.renderMealCard = function(cardData) {
    ...
    return `
        <div style="width:100%; aspect-ratio:4/5; background:linear-gradient(160deg, #052e2b 0%, #0f766e 44%, #2563eb 100%); display:flex; flex-direction:column; padding:28px 24px; box-sizing:border-box; position:relative; overflow:hidden;">
            ...
            <div style="z-index:1; flex:1; display:flex; flex-direction:column;">
                <div style="font-size:0.7rem; font-weight:800; letter-spacing:3px; text-transform:uppercase; color:rgba(255,255,255,0.7); margin-bottom:10px;">Meal shared</div>
                ...
                <div style="background:rgba(255,255,255,0.12); border:1px solid rgba(255,255,255,0.14); border-radius:14px; padding:15px 16px; margin-bottom:16px;">
                    <div style="font-size:0.75rem; color:rgba(255,255,255,0.68); text-transform:uppercase; letter-spacing:1px; margin-bottom:6px;">Food</div>
                ...
                <div style="display:flex; align-items:baseline; gap:7px; margin-bottom:14px;">
                    ...
                    <div style="font-size:0.82rem; color:rgba(255,255,255,0.62); font-weight:800;">kcal</div>
                </div>
                ...
                <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:9px; margin-top:auto;">
                    <div style="background:rgba(255,255,255,0.1); border-radius:12px; padding:11px 8px; text-align:center;">
                        ...
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.62); font-weight:800;">Protein</div>
                    </div>
                    <div style="background:rgba(255,255,255,0.1); border-radius:12px; padding:11px 8px; text-align:center;">
                        <div style="font-size:1.15rem; color:white; font-weight:900;">${carbs}g</div>
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.62); font-weight:800;">Carbs</div>
                    </div>
                    <div style="background:rgba(255,255,255,0.1); border-radius:12px; padding:11px 8px; text-align:center;">
                        <div style="font-size:1.15rem; color:white; font-weight:900;">${fat}g</div>
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.62); font-weight:800;">Fat</div>
                    </div>
                </div>
            </div>
...
window.renderLevelUpCard = function(cardData) {
    ...
    const titleTransition = (previousTitle && previousTitle !== title)
        ? `<div style="display:flex; align-items:center; justify-content:center; gap:10px; margin-bottom:8px;">
                <span style="font-size:0.85rem; color:rgba(255,255,255,0.5); text-decoration:line-through;">${previousTitle}</span>
    ...
    return `
        <div style="width:100%; aspect-ratio:4/5; background:${gradient}; display:flex; flex-direction:column; justify-content:center; align-items:center; padding:30px; box-sizing:border-box; position:relative; overflow:hidden;">
            ...
            <div style="text-align:center; z-index:1;">
                <div style="font-size:0.7rem; font-weight:800; letter-spacing:3px; text-transform:uppercase; color:rgba(255,255,255,0.7); margin-bottom:16px;">${tierLabel}</div>
                ...
                <div style="display:flex; gap:16px; justify-content:center; margin-top:16px;">
                    <div style="text-align:center;">
                        ...
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.6); margin-top:2px;">Total XP</div>
                    </div>
                    ${streak >= 2 ? `
                        <div style="width:1px; background:rgba(255,255,255,0.2);"></div>
                        <div style="text-align:center;">
                            <div style="font-size:1.1rem; font-weight:800; color:white;">🔥 ${streak}</div>
                            <div style="font-size:0.65rem; color:rgba(255,255,255,0.6); margin-top:2px;">Day Streak</div>
                        </div>
                    ` : ''}
                    <div style="width:1px; background:rgba(255,255,255,0.2);"></div>
                    <div style="text-align:center;">
                        <div style="font-size:1.1rem; font-weight:800; color:white;">${99 - level}</div>
                        <div style="font-size:0.65rem; color:rgba(255,255,255,0.6); margin-top:2px;">To Max</div>
                    </div>
                </div>
            </div>
...
window.loadPhotoFeed = async function(targetGridId = 'photo-feed-grid', emptyStateId = 'photo-feed-empty') {
    ...
    try {
        ...
        grid.innerHTML = sortedStories.map(story => {
            ...
            const isCardType = isWorkoutCard || isNutritionCard || isMealCard || isLevelUpCard;
            ...
            const captionHtml = (story.caption && !isCardType)
            ...
            return `
                <div class="feed-post-card" data-story-id="${storyId}" style="background:white; border-bottom:8px solid #f1f5f9;">
                    ...
                    <div onclick="if(typeof viewUserProfile==='function') viewUserProfile('${story.user_id}', '${(story.user_name || 'Unknown').replace(/'/g, "\\'")}', '${(story.profile_photo || '').replace(/'/g, "\\'")}')" style="display:flex; align-items:center; padding:10px 14px; gap:10px; cursor:pointer;">
    ...
    try {
        ...
        viewer.innerHTML = `
            ...
            <div style="display:flex; align-items:center; padding:15px 20px; gap:12px; flex-shrink:0;">
                <div onclick="closeFeedPostViewer(); if(typeof viewUserProfile==='function') viewUserProfile('${story.user_id}', '${(story.user_name || 'Unknown').replace(/'/g, "\\'")}', '${(story.profile_photo || '').replace(/'/g, "\\'")}')" style="width:40px; height:40px; border-radius:50%; background:var(--primary); display:flex; align-items:center; justify-content:center; overflow:hidden; flex-shrink:0; cursor:pointer;">
                    ${avatarHtml}
                </div>
                <div onclick="closeFeedPostViewer(); if(typeof viewUserProfile==='function') viewUserProfile('${story.user_id}', '${(story.user_name || 'Unknown').replace(/'/g, "\\'")}', '${(story.profile_photo || '').replace(/'/g, "\\'")}')" style="flex:1; cursor:pointer;">
