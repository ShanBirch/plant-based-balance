(function() {
        ...
        const BACKGROUND_UNLOCKS = [
            ...
            { name: 'arena', displayName: 'The Arena', unlockLevel: 1, icon: '🏆', theme: 'tamagotchi-bg-arena', image: './assets/tournament_arena.png' },
            { name: 'korin', displayName: 'Cloud Tower', unlockLevel: 1, icon: '☁️', theme: 'tamagotchi-bg-mountain', image: './assets/korin_tower.png' },
            { name: 'lookout', displayName: 'Sky Sanctuary', unlockLevel: 1, icon: '🏛️', theme: 'tamagotchi-bg-mountain', image: './assets/kamis_lookout.png' },
            { name: 'wasteland', displayName: 'Wasteland', unlockLevel: 1, icon: '🏜️', theme: 'tamagotchi-bg-mountain', image: './assets/wasteland.png' },
            { name: 'snake_way', displayName: 'Spirit Path', unlockLevel: 1, icon: '🌈', theme: 'tamagotchi-bg-none', image: './assets/snake_way.png' },
            { name: 'king_kai', displayName: 'Tiny Planet', unlockLevel: 1, icon: '🪐', theme: 'tamagotchi-bg-none', image: './assets/king_kais_planet.png' },
            { name: 'namek', displayName: 'The Green Planet', unlockLevel: 1, icon: '🌌', theme: 'tamagotchi-bg-mountain', image: './assets/planet_namek.png' },
            { name: 'frieza_ship', displayName: 'Space Station', unlockLevel: 1, icon: '🛸', theme: 'tamagotchi-bg-none', image: './assets/frieza_ship.png' },
            { name: 'dying_namek', displayName: 'Volcanic World', unlockLevel: 1, icon: '🌋', theme: 'tamagotchi-bg-mountain', image: './assets/dying_namek.png' },
            { name: 'time_chamber', displayName: 'The Void Chamber', unlockLevel: 1, icon: '⚪', theme: 'tamagotchi-bg-none', image: './assets/time_chamber.png' },
            { name: 'cell_arena', displayName: 'Championship Ring', unlockLevel: 1, icon: '🥋', theme: 'tamagotchi-bg-arena', image: './assets/cell_arena.png' },
            { name: 'kai_world', displayName: 'Sacred Grounds', unlockLevel: 1, icon: '🌳', theme: 'tamagotchi-bg-none', image: './assets/supreme_kai_world.png' },
            { name: 'inside_buu', displayName: 'The Mind Realm', unlockLevel: 1, icon: '🧠', theme: 'tamagotchi-bg-none', image: './assets/inside_buu.png' },
            ...
            { name: 'beerus', displayName: 'Cosmic Temple', unlockLevel: 1, icon: '🌠', theme: 'tamagotchi-bg-none', image: './assets/beerus_planet.png' },
