...
(function(){
  ...
  const WW_STYLES = `
    ...
    /* ─── $500 XP Giveaway reel — fresh palette, distinct from the other reels ─── */
    .ww-bg-jackpot   { background: radial-gradient(circle at 50% 25%, #fde047 0%, #15803d 38%, #052e16 90%); }
    .ww-bg-neon-pink { background: linear-gradient(135deg, #ec4899 0%, #831843 55%, #1a0510 100%); }
    .ww-bg-electric  { background: radial-gradient(circle at 70% 30%, #22d3ee 0%, #1e40af 55%, #020617 100%); }
    .ww-bg-abyss     { background: linear-gradient(160deg, #0e7490 0%, #0c4a6e 55%, #020617 100%); }
    .ww-bg-aurora    { background: linear-gradient(135deg, #a855f7 0%, #ec4899 55%, #f59e0b 100%); }
    .ww-bg-countdown { background: radial-gradient(circle at 50% 55%, #fb7185 0%, #9f1239 45%, #1a0505 100%); }
  ...
  // ────────────────────────────────────────────────────────────
  //  REEL 7 — $500 XP Challenge ("30 days. Most XP. Winner takes $500.")
  //  Social-first giveaway promo for IG/TikTok. No user data needed —
  //  screen-record from admin like the other reels.
  // ────────────────────────────────────────────────────────────

  function buildChallengeReel(){
    return [
      // 1. HOOK — stop the scroll
      { bg: 'ww-bg-jackpot', hold_ms: 4000, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-halftone"></div>
        <div class="ww-kicker">We're giving away</div>
        <div class="ww-big-num" style="font-size: clamp(4.5rem, 22vw, 11rem); line-height:1; text-shadow: 5px 5px 0 #052e16, 10px 10px 0 rgba(5,46,22,0.5);">$500</div>
        <div class="ww-caption" style="font-weight:800; margin-top:12px;">No catch. No cost.</div>
        <div class="ww-stamp gold" style="margin-top:18px;">30-DAY GIVEAWAY</div>
      `},
      // 2. FREE to enter
      { bg: 'ww-bg-neon-pink', hold_ms: 3500, html: `
        <div class="ww-halftone"></div>
        <div class="ww-kicker">Entry fee?</div>
        <div class="ww-big-num" style="font-size: clamp(5rem, 22vw, 11rem); line-height:1;">$0</div>
        <div class="ww-caption">Totally free. Just download the app.</div>
        <div class="ww-stamp green" style="margin-top:20px;">FREE TO ENTER</div>
      `},
      // 3. RULES — start date + 30 days + most XP
      { bg: 'ww-bg-electric', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Starts 27 April · runs 30 days</div>
        <div class="ww-big-num" style="font-size: clamp(3rem, 13vw, 6.4rem); line-height:1.05;">most XP<br>WINS.</div>
        <div class="ww-caption" style="margin-top:12px;">Highest XP gained in 30 days. That's it.</div>
      `},
      // 4. WAYS TO EARN XP
      { bg: 'ww-bg-abyss', hold_ms: 5000, html: `
        <div class="ww-halftone"></div>
        <div class="ww-kicker">Earn XP by…</div>
        <div style="display:inline-flex; flex-direction:column; gap:clamp(10px, 2.2vw, 16px); margin-top:18px; font-size:clamp(1.15rem, 5.4vw, 1.85rem); font-weight:900; line-height:1.1; text-align:left;">
          <div style="display:flex; align-items:center; gap:14px; white-space:nowrap;"><span style="font-size:1.35em; width:1.6em; text-align:center;">🏋️</span><span>logging workouts</span></div>
          <div style="display:flex; align-items:center; gap:14px; white-space:nowrap;"><span style="font-size:1.35em; width:1.6em; text-align:center;">📸</span><span>tracking meals</span></div>
          <div style="display:flex; align-items:center; gap:14px; white-space:nowrap;"><span style="font-size:1.35em; width:1.6em; text-align:center;">🎓</span><span>finishing lessons</span></div>
          <div style="display:flex; align-items:center; gap:14px; white-space:nowrap;"><span style="font-size:1.35em; width:1.6em; text-align:center;">🔥</span><span>keeping streaks</span></div>
        </div>
        <div class="ww-caption" style="margin-top:20px;">Every action counts. Every day adds up.</div>
      `},
      // 5. TROPHIES — the one and only place we say "top 3"
      { bg: 'ww-bg-jackpot', hold_ms: 5200, html: `
        <div class="ww-halftone"></div>
        <div class="ww-kicker">After 30 days</div>
        <div style="display:flex; gap:clamp(16px, 5vw, 28px); align-items:flex-end; justify-content:center; margin-top:18px; font-size:clamp(3.2rem, 14vw, 6.4rem); line-height:1; text-shadow: 4px 4px 0 #052e16;">
          <span>🥈</span><span style="font-size:1.25em;">🥇</span><span>🥉</span>
        </div>
        <div class="ww-caption" style="font-weight:800; margin-top:18px;">the <strong>top 3</strong> take the <strong>$500 giveaway</strong>.</div>
      `},
      // 6. URGENCY — the date
      { bg: 'ww-bg-countdown', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Mark the calendar</div>
        <div class="ww-big-num" style="font-size: clamp(4rem, 19vw, 9.5rem); line-height:1;">27 APR</div>
        <div class="ww-caption" style="margin-top:12px;">Download now. Be ready for day one.</div>
        <div class="ww-flame" style="margin-top:10px; font-size: clamp(3rem, 11vw, 5rem);">🔥</div>
      `},
      // 7. CTA — clean outro (no un-tappable store pills / Done button,
      // since for social the reel is a rendered video and taps don't work)
      { bg: 'ww-bg-intro', hold_ms: 6500, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-halftone"></div>
        ${REEL_LOGO}
        <div class="ww-big-num" style="font-size: clamp(2.4rem, 10vw, 4.8rem); margin-top:22px; line-height:1;">BALANCE</div>
        <div class="ww-caption" style="font-size:0.95rem; margin-top:6px; opacity:0.92;">$500 Giveaway · Starts 27 April</div>
        <div class="ww-stamp gold" style="margin-top:26px;">DOWNLOAD FREE</div>
      `},
    ];
  }
  ...
  //  pulse, keep good guesses, update bad ones. Lands on the
  //  Free Energy Principle (Friston): the brain's one job is to
  //  shrink the gap between prediction and signal, and the
  //  rewiring that happens to shrink it IS learning. Light
  //  callback to the nose / blind-spot beats from the identity
  //  reel — same engine, different question.
  // ────────────────────────────────────────────────────────────
  ...
  function buildAskLearningReel(){
    ...
    return [
      ...
      twLine('gpt',  'It can\'t even touch your skin.',                                   { speed: NORM, pause: 700 }),
      twLine('gpt',  'It doesn\'t know it has fingers.',                                  { speed: SLOW, pause: 1300 }),
      ...
      twLine('gpt',  'It doesn\'t even know there <em>is</em> a world.',                  { speed: SLOW, pause: 1100 }),
      twLine('gpt',  'It just gets pulses.',                                              { speed: NORM, pause: 700 }),
      ...
      // ── CALLBACK — same engine as the nose / blind spot ──────
      twLine('gpt',  'Remember the nose trick? The blind spot?',                          { speed: NORM, pause: 800 }),
      twLine('gpt',  'How your brain edits parts of reality out, paints other parts in?', { speed: NORM, pause: 900 }),
      twLine('gpt',  'Same engine.',                                                      { speed: SLOW, pause: 800 }),
      twLine('gpt',  'You don\'t see reality.',                                           { speed: NORM, pause: 700 }),
      twLine('gpt',  'You see your brain\'s <strong>best running guess</strong> of it.',  { speed: SLOW, pause: 1200 }),
      ...
      twLine('gpt',  'There\'s a guy named <strong>Karl Friston</strong>.',               { speed: NORM, pause: 800 }),
      twLine('gpt',  'He came up with the <strong>Free Energy Principle</strong>.',      { speed: SLOW, pause: 1100 }),
      twLine('gpt',  'It says your brain has one mathematical job, end-to-end:',          { speed: NORM, pause: 900 }),
      twLine('gpt',  '<strong>Shrink the gap.</strong>',                                  { speed: SLOW, pause: 1300 }),
      twLine('gpt',  'Every time a prediction misses, the brain rewires itself a tiny bit…', { speed: NORM, pause: 700 }),
      twLine('gpt',  'so it won\'t miss the same way again.',                             { speed: NORM, pause: 1100 }),
      twLine('gpt',  'That rewiring — that update —',                                     { speed: NORM, pause: 700 }),
      twLine('gpt',  '<strong>is learning.</strong>',                                     { speed: SLOW, pause: 1500 }),
      ...
      twLine('gpt',  'If your prediction is never wrong — <em>nothing\'s happening</em>.', { speed: NORM, pause: 900 }),
      twLine('gpt',  'If it\'s wrong all the time — <em>you\'re overwhelmed</em>.',       { speed: NORM, pause: 1000 }),
      twLine('gpt',  'The sweet spot:',                                                   { speed: NORM, pause: 600 }),
      twLine('gpt',  '<strong>Just past the edge of what you already get.</strong>',      { speed: SLOW, pause: 1400 }),
  ...
  const REELS = {
    ...
    'challenge': { name: '$500 Giveaway · 27 Apr', emoji: '🎁', theme: 'trap',      build: buildChallengeReel, needsFitgotchi: false },
