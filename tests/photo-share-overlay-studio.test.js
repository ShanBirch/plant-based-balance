...
assert.ok(dashboard.includes('dashboard-script-10-points_widget_functions.js?v=56-movable-workout-card'), 'phones must load the new share composer');
...
assert.ok(serviceWorker.includes("const CACHE_NAME = 'pbb-app-v461-movable-workout-share'"), 'the app shell cache must be refreshed');
assert.ok(serviceWorker.includes('dashboard-script-10-points_widget_functions.js?v=56-movable-workout-card'), 'the new share composer must be precached');
