-- Feed order: show posts chronologically from earliest to latest.
...
COMMENT ON FUNCTION public.get_network_active_stories IS
  'Returns all active non-test-account stories for the Balance community feed, ordered from earliest to latest.';
