...
- `assets/balance-logo.png` — official transparent Balance harmony mark, suitable for the opening watermark and final lockup.
...
These screens are factual product references and proof assets. The video should crop,
layer and animate their strongest details inside designed phone/UI choreography. It
must not present them as a static screenshot slideshow. The meal-plan delivery cards
and Shannon inbox voice-note moment may be reconstructed as faithful Balance UI
components from the current product language because no clean dedicated captures exist.
