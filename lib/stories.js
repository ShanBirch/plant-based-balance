    ...
    try {
        ...
        const renderedFeedHtml = sortedStories.map(story => {
            ...
            const thumbnailSrc = isVideo
                ? (videoPreviewSrc || getSafeFeedMediaUrl(story.thumbnail_url))
            ...
            return `
                <div class="feed-post-card" data-story-id="${storyId}" style="background:white; border-bottom:8px solid #f1f5f9;">
                    ...
                    ${isCardType ? (() => {
                        ...
                        ${isVideo && videoPreviewSrc ? renderFeedVideoPreview(story) : `<img src="${escapeHtml(thumbnailSrc || '')}" style="width:100%; display:block; object-fit:cover;" loading="lazy" onerror="this.style.display='none'; this.parentElement.style.minHeight='200px'; this.parentElement.style.background='#f1f5f9';">`}
                        ${videoIcon}
