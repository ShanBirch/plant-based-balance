...
(function(){
  ...
  function buildChallengeWeekOneSlides(stats){
    ...
    return [
      { bg: 'ww-bg-challenge-week', hold_ms: 2600, html: `
      ...
      `},
      { bg: 'ww-bg-challenge-action', hold_ms: 2900, html: `
        <div class="ww-speed-lines"></div>
      ...
      `},
      { bg: 'ww-bg-challenge-score', hold_ms: 2900, html: `
        <div class="ww-halftone"></div>
        ...
        <div class="ww-caption" style="color:#101820; font-weight:900;">${pbs} PBs hit in week one</div>
      `},
      { bg: 'ww-bg-challenge-night', hold_ms: 3000, html: `
      ...
      `},
      { bg: 'ww-bg-challenge-night', hold_ms: 3200, html: `
        <div class="ww-speed-lines"></div>
      ...
      `},
      { bg: 'ww-bg-challenge-score', hold_ms: 3000, html: `
        <div class="ww-halftone"></div>
