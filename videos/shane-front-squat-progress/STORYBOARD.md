...
- duration: 6.5s
- beat: A dated coaching receipt sets 150 kg over eight weeks, then the three-session structure assembles
...
## Frame 6 - Clear plan, real feedback
- status: animated
- src: compositions/frames/06-close.html
- duration: 5s
- beat: Resolve the verified claim and Balance lock-up with a glimmer
