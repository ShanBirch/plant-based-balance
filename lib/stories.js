...
function setupStoryGestures() {
    ...
    // Add touch listeners
    contentContainer.addEventListener('touchstart', handleStoryTouchStart, { passive: true });
    contentContainer.addEventListener('touchend', handleStoryTouchEnd, { passive: true });
    contentContainer.addEventListener('touchcancel', handleStoryTouchCancel, { passive: true });
}
