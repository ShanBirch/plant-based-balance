...
(function(){
  ...
  function buildAskMotivationReel(){
    return [
      // Opening prompt
      ...askLines([
        { who: 'user', text: 'Hey ChatGPT…<br>what is motivation?',  hold: 3200 },
        { who: 'gpt',  text: 'Good question.<br>Let me show you.',    hold: 3000 },
      ], 'Episode 1'),

      // Three very different Sundays
      ...askLines([
        { who: 'user', text: 'Why does one man spend Sunday fixing his car?',          hold: 3800 },
        { who: 'user', text: 'Why does another sit in a church pew?',                   hold: 3500 },
        { who: 'user', text: 'Why does another feed his paycheck into the pokies?',    hold: 4200 },
      ], 'The question'),

      // Setup
      ...askLines([
        { who: 'gpt', text: 'Same brain.<br>Different behaviour.',   hold: 3000 },
        { who: 'gpt', text: 'Here\'s why.',                            hold: 2500 },
      ]),

      // One job
      askLine('gpt', 'Every human brain has <strong>one job</strong>:<br>keep you alive.', 4200),

      // Watches + learns
      ...askLines([
        { who: 'gpt', text: 'But it doesn\'t know what "alive" looks like for <em>you</em>.', hold: 4200 },
        { who: 'gpt', text: 'So it watches.<br>And it learns.',                                 hold: 3500 },
      ]),

      // The HOW — the mechanism (one long bubble, needs more hold)
      askLine('gpt', 'Here\'s how it works:<ol><li>You do something.</li><li>Something happens next — a reward, a feeling, relief.</li><li>Your brain files it: <em>"do this → get that."</em></li><li>Next time, it <strong>nudges you</strong> toward what paid off before.</li></ol>', 10000, 'How the brain learns'),

      // The nudge IS motivation
      askLine('gpt', 'That nudge…<br>is <strong>motivation</strong>.', 3800),

      // Three guys → three learned loops
      ...askLines([
        { who: 'gpt', text: 'Car guy learned →<br><em>fix the thing → feel competent → safe.</em>',   hold: 4500 },
        { who: 'gpt', text: 'Churchgoer learned →<br><em>show up → belong → safe.</em>',                hold: 4200 },
        { who: 'gpt', text: 'Pokies player learned →<br><em>near-win → dopamine → safe.</em>',         hold: 4200 },
      ], 'Same code, different inputs'),

      // Same code, different environments
      ...askLines([
        { who: 'gpt', text: 'Three different men.<br>Three different Sundays.',                         hold: 3800 },
        { who: 'gpt', text: '<strong>Same survival code.<br>Different environments.</strong>',           hold: 4500 },
      ]),

      // Shan follow-up
      ...askLines([
        { who: 'user', text: 'So motivation isn\'t willpower?',                                          hold: 3200 },
        { who: 'gpt',  text: 'No.<br>It\'s your brain predicting what <strong>worked last time</strong>.', hold: 4500 },
      ]),

      // The environment lever
      ...askLines([
        { who: 'gpt', text: 'Change your <strong>environment</strong> →', hold: 3200 },
        { who: 'gpt', text: 'change the <strong>prediction</strong> →',   hold: 3200 },
        { who: 'gpt', text: 'change what you do.',                          hold: 3800 },
      ], 'The lever'),
