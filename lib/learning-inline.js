    ...
    function renderLearningHome() {
        ...
        container.innerHTML = `
            ...
            <div id="xp-info-banner" style="margin: 15px; padding: 16px 20px; background: linear-gradient(135deg, #059669 0%, #10b981 100%); border-radius: 16px; display: flex; align-items: center; gap: 15px; position: relative;">
                ...
                <button onclick="document.getElementById('xp-info-banner').style.display='none'; localStorage.setItem('xpBannerDismissed','true');" style="background: rgba(255,255,255,0.2); border: none; color: white; width: 44px; height: 44px; min-width: 44px; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 14px; line-height: 1; padding: 0; flex-shrink: 0;">✕</button>
            </div>
            ` : ''}
