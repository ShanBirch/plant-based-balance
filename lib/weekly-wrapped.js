...
(function(){
  ...
  function buildAskConditioningReel(){
    ...
    return [
      ...
      // ── THE FIX — you can't stop a prediction, only teach a new one ─
      ...
      twLine('gpt',  'The only way forward is to <strong>teach the engine a new prediction</strong>.', { speed: SLOW, pause: 1200 }),
      twLine('gpt',  'Two ways.',                                                           { speed: SLOW, pause: 1000 }),

      // Method 1 — starve
      twLine('gpt',  '<strong>1. Starve the old pair.</strong>',                            { speed: SLOW, pause: 900 }),
      ...
      // Method 2 — replace
      twLine('gpt',  '<strong>2. Teach a better pair.</strong>',                            { speed: SLOW, pause: 900 }),
