...
assert.ok(
    dashboardSource.includes('dashboard-style-1.css?v=83') &&
        dashboardSource.includes('pbb-premium-overlays.css?v=113-custom-foods-community') &&
        dashboardSource.includes('dashboard-script-meal-builder.js?v=6-custom-foods-community') &&
