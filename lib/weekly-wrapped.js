  ...
  function levelSagaLogoFinalSlide(){
    return {
      ...
      html: `
        ...
        <div class="ww-big-num" style="font-size: clamp(2.2rem, 9vw, 4.4rem); margin-top:22px; line-height:1;">BALANCE</div>
        <div class="ww-caption" style="font-size:0.95rem; margin-top:6px; opacity:0.92;">Fitness Gamified</div>
        <div class="ww-caption" style="margin-top:16px;">Unlock the DBZ saga from LVL 55. Start with Kid Goku, grind all the way up to Kid Buu.</div>
  ...
  function buildLevelCharacterReel(){
    return [
      ...
      { bg: 'ww-bg-level-saga', hold_ms: 5000, html: `
        ...
        ${powerOrbRing('55')}
        <div class="ww-caption">First drop: <strong>Kid Goku</strong>. The saga begins.</div>
      `},
      { bg: 'ww-bg-pbs', hold_ms: 5000, html: `
        ...
        ${levelLadder([
          { level: 55, label: 'Kid Goku' },
          { level: 60, label: 'Piccolo' },
          { level: 65, label: 'Vegeta' },
          { level: 70, label: 'Gohan' },
          { level: 75, label: 'Trunks' },
        ])}
      `},
      { bg: 'ww-bg-level-saga', hold_ms: 5000, html: `
        <div class="ww-ki-aura"></div>
        ...
        ${levelLadder([
          { level: 80, label: 'Android 18' },
          { level: 85, label: 'Frieza' },
          { level: 90, label: 'Cell' },
          { level: 95, label: 'Broly' },
          { level: 99, label: 'Kid Buu' },
        ])}
        <div class="ww-caption">Work your way through the full DBZ arc, right up to Kid Buu.</div>
      `},
