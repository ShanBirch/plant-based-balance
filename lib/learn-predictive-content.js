...
(function(root) {
  ...
  const rows = [
    ...
    ['mind-6-5','Other people change the context',
      `Other people can influence what you notice, what feels normal and the support available for a new routine. That influence is not a guarantee, and it is not a simple formula that determines your behaviour.\n\nA supportive gym instructor can explain a movement, answer a question and help make the first visit more predictable. A friend may help you find a suitable time or make returning feel less daunting. Those are specific changes in the situation that you can observe.\n\nTalk with someone outside your coaching relationship about the routine you are building. Afterwards, notice whether the conversation changed your expectations, motivation or sense of support. It may help, make no difference or feel difficult. Report the actual outcome without needing to identify the other person.`,
      'Social support is part of the context; observe its actual effect rather than assuming one.',
      'A conversation about your gym routine made no difference to motivation. What should you record?',['Pretend it helped','The conversation and the neutral outcome','Nothing, because only success counts'],1,
      'An honest neutral outcome is useful evidence about this attempt.',
      'Social surroundings determine behaviour with certainty.',false],
  ...
  const practice = {
    ...
    'mind-6-5': [
      ['How might an instructor make a first gym visit more predictable?', ['By choosing all your future behaviour','By explaining a movement and answering questions','By guaranteeing motivation'],1,'Practical help changes the information and support available in that situation.'],
      ['Who does the lesson suggest talking to for this experiment?', ['Someone outside your coaching relationship','Only your coach','Someone whose identity you must publish'],0,'Try a conversation outside coaching, then report its effect without identifying the person.'],
      ['Which check-in best captures the experiment?', ['My friend guarantees I will keep training','Everyone should find a training partner','We discussed a gym time; I felt more supported but still unsure'],2,'Describe the conversation and its actual effect, including mixed feelings.']
    ],
    'mind-4-2': [
