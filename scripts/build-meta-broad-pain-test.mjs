...
const ads = [
  ...
  },
  {
    ...
    primaryText: "Work, kids, shifts and low-energy days are not failures. They are part of the plan. Inside Balance, we help you choose a realistic training rhythm, explain why it fits, and keep you in control of the final decision. The Founders Pass includes six weeks with Shannon plus lifetime core app access for AU$99 once. Message 'BALANCE' to take a look.",
...
const plan = {
  ...
  offer: 'Balance Founders Pass, AU$99 once',
