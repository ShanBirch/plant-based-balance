...
function validatePayload(body = {}, now = new Date()) {
    ...
    return {
        value: {
            ...
            support,
            note,
            app_coaching_feedback: cleanString(body.app_coaching_feedback, 900),
...
function responseSummary(response) {
    return [
        ...
        response.app_coaching_feedback ? `App and coaching feedback: ${response.app_coaching_feedback}` : '',
