...
assert.ok(
    dashboard.includes('dashboard-script-10-points_widget_functions.js?v=45') &&
  serviceWorker.includes("const CACHE_NAME = 'pbb-app-v313'") &&
        serviceWorker.includes('./js/dashboard/dashboard-script-10-points_widget_functions.js?v=45'),
