...
(async function() {
  ...
  if (requestedMetaAdTrial && storedSession) {
    ...
    window.metaAdTrialMode = window.BalanceMetaAdTrial.restoreAuthenticatedMode(storedSession.user.id)
  ...
  // Balance Learn is a fixed eight-week programme. Grandfathered lifetime
