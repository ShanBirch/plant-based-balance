...
export const POINTS_CONFIG = {
  ...
  POINTS_PER_PROGRESS_PHOTO_SHARE: 10, // 10 bonus points for sharing weekly progress photos to the feed
...
export const LEVEL_CONFIG = {
  MAX_LEVEL: 99,
  // XP curve: points = 0.07 * level^2.4 + 0.7 * level
  // Linear term keeps early levels easy (hook phase), steep exponent makes later levels a grind.
  // - Level 10: ~24 points (~2 days)
  // - Level 20: ~106 points (~1 week)
  // - Level 30: ~266 points (~2.5 weeks)
  // - Level 50: ~872 points (~2 months, ~3 days per level)
  // - Level 75: ~2266 points (~5 months, ~5-6 days per level)
  // - Level 99: ~4380 points (~10 months, ~8 days per level)
