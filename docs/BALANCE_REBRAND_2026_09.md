...
## Sender and delivery verified
Gmail Send mail as now includes shannon@balanceneurosciencefitness.com and it is the default sender. A test sent from this address arrived in Shannon's personal Gmail inbox; a reply to the new address arrived in the existing business inbox. Both directions were verified in Gmail. Public website mailto links and displayed contact addresses now use the new address. The existing FormSubmit recipient remains unchanged to preserve its verified routing to the same inbox. Instagram's mobile profile link change remains outstanding; DMARC rollout and broader host/canonical migration remain separate unfinished checklist items.
