const CACHE_NAME = 'pbb-app-v422-course-tour-handoff'; // v422: refresh the required course-preview hook and Feed-to-Home handoff
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=222-add-exercise-contrast',
