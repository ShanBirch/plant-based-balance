...
test('phones fetch the thumbnail renderer and video logic together', () => {
  const workoutVersion = 'dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=197-photo-ready-tour';
  ...
  assert.match(serviceWorkerSource, /const CACHE_NAME = 'pbb-app-v350-photo-ready-tour'/);
});
