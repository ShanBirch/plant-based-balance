...
- Balance Learn is one AUD $149 payment for the full eight weeks and does not auto-renew.
- It includes a structured eight-week course, eight weeks of app/community access, one weekly check-in, and workout and food review/adjustments from Shannon.
- Online Coaching is the ongoing individual progression option after Balance Learn, or as a direct ongoing start.
...
- Balance Learn includes one weekly check-in with workout and food review and practical adjustments. It does not include unlimited daily coaching or live calls.
...
HANDLING OBJECTIONS:
- "Price?" -> "Balance Learn is one $149 payment for the full eight weeks. It includes one weekly check-in and plan review, and it doesn't renew automatically"
- "Do I need a call?" -> "no, you can join straight through the page. the founders pass is the eight-week Balance Learn course with my weekly review inside Balance"
- "What's included?" -> "the eight-week Balance Learn course, eight weeks of app and community access, and one weekly check-in plus workout and food review with me"
