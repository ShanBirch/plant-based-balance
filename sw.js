const CACHE_NAME = 'pbb-app-v253'; // v253: optional FitGotchi and compact Home level bar
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=145',
