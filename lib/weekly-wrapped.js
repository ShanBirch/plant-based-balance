...
(function(){
  ...
  function buildAskFreewillReel(){
    ...
    return [
      ...
      askSlide([
        { who: 'user', text: 'Hey ChatGPT…<br>do I actually have free will?' },
        { who: 'gpt',  text: 'Honest answer from 30 years of brain scans?<br><strong>Probably not.</strong>' },
        { who: 'gpt',  text: 'But stick with me — this is <em>good news</em>. Three experiments.' },
      ], 5000, 'Episode 3'),

      // 2. The claim
      askSlide([
        { who: 'gpt', text: 'Everyone feels like they\'re the one making decisions. <em>"I chose this."</em>' },
        { who: 'gpt', text: 'But when scientists watch the actual moment of choice on a brain scanner, something weird happens:' },
        { who: 'gpt', text: 'The brain decides <strong>first</strong>. The <em>feeling</em> of deciding arrives <strong>later</strong>.' },
      ], 6500, 'The claim'),

      // 3. Libet setup
      askSlide([
        { who: 'gpt', text: 'Experiment 1. Benjamin Libet hooks you up to an <strong>EEG</strong> — a cap that reads your brain activity in real time.' },
        { who: 'gpt', text: 'Task: flick your wrist whenever you feel like it. Watch this clock — the instant you <em>feel the urge</em>, remember where the dot is.' },
      ], 6500, 'Study 1 · Libet · 1983'),

      // 4. Libet finding — the gap
      askSlide([
        { who: 'gpt', text: 'Now he has three timestamps: when your <strong>brain</strong> started preparing, when <strong>you</strong> felt yourself decide, and when your <strong>hand</strong> moved.' },
        { who: 'gpt', text: `Here's what he found:${LIBET_TIMELINE}` },
        { who: 'gpt', text: 'Your brain committed <strong>a third of a second before</strong> you consciously chose. Your awareness was the <em>last to know.</em>' },
      ], 7500),

      // 5. The rebuttal → Soon intro
      askSlide([
        { who: 'user', text: 'Okay but that\'s just a wrist flick. Maybe that\'s reflex.' },
        { who: 'gpt',  text: 'That\'s what everyone said for 25 years.<br>Then 2008 happened.' },
      ], 4500),

      // 6. Soon — 10 seconds
      askSlide([
        { who: 'gpt',  text: 'Berlin. A proper <strong>fMRI scanner</strong> — reads deep brain activity. You pick left button or right button, whenever you want.' },
        { who: 'gpt',  text: 'A computer reads your brain patterns and predicts your choice…<br><strong>up to 10 seconds</strong> before you feel yourself choose.' },
        { who: 'user', text: 'Ten <em>seconds?!</em>' },
        { who: 'gpt',  text: 'Imagine ordering coffee and the barista started making it 10 seconds before you opened your mouth.' },
      ], 8000, 'Study 2 · Soon et al. · 2008'),

      // 7. Desmurget setup
      askSlide([
        { who: 'gpt', text: 'Final experiment — the kicker.' },
        { who: 'gpt', text: 'French surgeon Michel Desmurget operating on brain tumours. Patients are <strong>awake</strong> — the brain has no pain receptors, and staying conscious lets the surgeon test each region before cutting.' },
        { who: 'gpt', text: 'While the skull\'s open, he gently electrically stimulates different spots and asks what the patient feels.' },
      ], 7500, 'Study 3 · Desmurget · 2009'),

      // 8. Parietal zap — feeling without moving
      askSlide([
        { who: 'gpt', text: 'First spot: the <strong>parietal cortex</strong>, near the top of your head.' },
        { who: 'gpt', text: 'He zaps it. The patient instantly says:<br><em>"I wanted to move my right hand."</em>' },
        { who: 'gpt', text: 'But here\'s the thing — <strong>their hand never moved.</strong> The muscles never fired.' },
        { who: 'gpt', text: 'The <em>feeling of willing it</em> was manufactured by the electrode. No decision was made. They just <strong>felt like they made one.</strong>' },
      ], 8500),

      // 9. Premotor zap + "two rooms"
      askSlide([
        { who: 'gpt', text: 'Now he moves the electrode a few centimetres over, to the <strong>premotor cortex</strong>, and zaps that instead.' },
        { who: 'gpt', text: 'The patient\'s hand <strong>actually moves.</strong> Clearly, visibly.<br>He asks: <em>"Did you just move your hand?"</em><br>Patient: <strong>"No. I didn\'t do anything."</strong>' },
        { who: 'gpt', text: 'Feeling-of-choosing and act-of-choosing live in <strong>different rooms</strong>. You can zap one without the other.' },
        { who: 'gpt', text: 'So your sense of <em>"I chose this"</em> isn\'t the <em>cause</em> of the action. It\'s a <strong>separate signal</strong> your brain produces alongside it — to make the action feel like yours.' },
      ], 9000),

      // 10. Gazzaniga — the interpreter / confabulation
      askSlide([
        { who: 'gpt', text: 'One more twist. What happens when you do something your conscious brain didn\'t order?' },
        { who: 'gpt', text: 'Michael Gazzaniga studied <strong>split-brain</strong> patients — left and right hemispheres surgically separated, unable to talk to each other.' },
        { who: 'gpt', text: 'He\'d flash an instruction to the silent right hemisphere: <em>"stand up."</em> The patient stood up. Then he\'d ask: <em>"Why?"</em>' },
        { who: 'gpt', text: 'The verbal left hemisphere never saw the instruction — but it <strong>never says "I don\'t know."</strong> It confidently invents a reason: <em>"I felt like getting a drink."</em>' },
        { who: 'gpt', text: 'Your brain would rather <strong>make up a story</strong> than admit it isn\'t in charge.' },
      ], 9500, 'The interpreter'),

      // 11. The lesson
      askSlide([
        { who: 'user', text: 'So… who\'s actually running me?' },
        { who: 'gpt',  text: '<strong>You</strong> are what your brain shows you — a third of a second after it\'s already decided.<br>Not the captain. The <em>narrator</em>.' },
        { who: 'gpt',  text: 'Here\'s why that\'s good news: every time you\'ve called yourself <strong>lazy, weak, no willpower</strong> — you were blaming the <em>narrator</em> for what the brain had already committed to.' },
        { who: 'gpt',  text: 'You can\'t out-willpower a brain that decided before you felt it.<br>But you <strong>can</strong> change what it learns to decide.' },
        { who: 'gpt',  text: '🔔 Change what you <strong>pair</strong> (Ep 2).<br>🌱 Change your <strong>environment</strong> (Ep 1).<br>That\'s the lever.' },
        { who: 'gpt',  text: '<em>"We are not captains of our ship.<br>Our ships never had captains."</em><br>— Sapolsky' },
      ], 11000, 'The lesson'),
  ...
  function buildAskIdentityReel(){
    return [
      // 1. Interactive hook — the nose trick
      askSlide([
        { who: 'user', text: 'Hey ChatGPT, quick question—' },
        { who: 'gpt',  text: 'Before you ask. Look straight at the screen.' },
        { who: 'gpt',  text: '…now <strong>think about your nose.</strong>' },
        { who: 'user', text: '…wait. I can see it now. I couldn\'t a second ago.' },
        { who: 'gpt',  text: 'Exactly.<br>Buckle up.' },
      ], 6500, 'Episode 4'),

      // 2. Why you don't see your nose
      askSlide([
        { who: 'gpt', text: 'Your nose is in your visual field <strong>every waking second of your life.</strong>' },
        { who: 'gpt', text: 'Your eyes have been sending that image to your brain the entire time.' },
        { who: 'gpt', text: 'But your brain decided a long time ago: <em>"this is useless information."</em>' },
        { who: 'gpt', text: 'So it <strong>edits it out.</strong> You stop seeing what\'s actually there.' },
      ], 8000, 'Your brain edits reality'),

      // 3. The blind spot
      askSlide([
        { who: 'gpt', text: 'Want something weirder?' },
        { who: 'gpt', text: 'Every eye has a literal <strong>hole</strong> in the retina — the spot where the optic nerve exits. No photoreceptors. No image.' },
        { who: 'gpt', text: 'So why don\'t you see two black dots floating in front of you right now?' },
        { who: 'gpt', text: 'Because your brain <strong>paints over the hole</strong> with its best guess of what should be there.<br>You never notice.' },
      ], 8000),

      // 4. The rule
      askSlide([
        { who: 'gpt', text: 'Here\'s the rule you were never taught:' },
        { who: 'gpt', text: 'You don\'t see reality.<br>You see your brain\'s <strong>best guess</strong> of reality — edited for usefulness.' },
        { who: 'gpt', text: 'When the guess is close enough, you never question it. When it isn\'t, you call it an <em>illusion</em>.' },
      ], 6500, 'The rule'),

      // 5. It's not just vision
      askSlide([
        { who: 'gpt', text: 'And it\'s not just eyes.' },
        { who: 'gpt', text: '🎨 <strong>Colour</strong> is a label your brain invents. A tomato isn\'t "red" — it\'s reflecting a wavelength.' },
        { who: 'gpt', text: '👅 <strong>Flavour</strong> is 80% smell. Block your nose and strawberry tastes like sugar water.' },
        { who: 'gpt', text: '🩹 <strong>Pain</strong> is constructed. Amputees feel pain in limbs that aren\'t there anymore.' },
        { who: 'gpt', text: 'Every sense you have is a <strong>controlled hallucination.</strong>' },
      ], 9500, 'All of it'),

      // 6. Shan's pushback
      askSlide([
        { who: 'user', text: 'Okay, but that\'s just my senses.<br>I\'m still <em>me</em>.' },
        { who: 'gpt',  text: 'Ah.<br>About that.' },
      ], 4000),

      // 7. The twist — and so are you
      askSlide([
        { who: 'gpt', text: 'You feel like there\'s a <strong>"you"</strong> watching through your eyes. A single, continuous person. The voice in your head. The one making decisions.' },
        { who: 'gpt', text: 'Neuroscientists have spent 50 years looking for that person.' },
        { who: 'gpt', text: 'They can\'t find one.<br>There is no single spot in your brain that\'s <em>"you."</em>' },
      ], 7000, 'And so are you'),

      // 8. Memory is reconstructed, not replayed
      askSlide([
        { who: 'gpt', text: 'You think you <em>remember</em> your past.' },
        { who: 'gpt', text: 'You don\'t. Every time you recall a memory, your brain <strong>rebuilds it from scratch</strong> — and the new version overwrites the old one.' },
        { who: 'gpt', text: 'Your childhood is a painting your brain repaints every time you look at it.' },
      ], 7000),

      // 9. The rubber hand illusion
      askSlide([
        { who: 'gpt', text: 'Classic experiment. Hide someone\'s real hand. Put a <strong>rubber hand</strong> in front of them. Stroke both with a brush at the same time.' },
        { who: 'gpt', text: 'In about <strong>30 seconds</strong>, their brain decides the rubber hand is theirs.<br>Smash it with a hammer — they flinch. Real panic.' },
        { who: 'gpt', text: 'Your brain doesn\'t even know what counts as <strong>your own body.</strong><br>It\'s guessing.' },
      ], 7500, 'The rubber hand'),

      // 10. Identity as a story
      askSlide([
        { who: 'gpt', text: 'So if there\'s no "you" in the brain, what <em>are</em> you?' },
        { who: 'gpt', text: 'You\'re a <strong>story</strong>. A narrative your brain keeps writing, second by second — from memories (reconstructed), senses (hallucinated), and decisions (already made. remember Ep 3?).' },
        { who: 'gpt', text: 'Identity isn\'t a thing you <em>have</em>.<br>It\'s a thing your brain is <strong>making right now.</strong>' },
      ], 7500),

      // 11. The lesson — the freeing version
      askSlide([
        { who: 'user', text: 'That\'s terrifying.<br>And also… kinda freeing?' },
        { who: 'gpt',  text: 'Exactly.' },
        { who: 'gpt',  text: 'If the "you" is a construction, you don\'t have to <em>discover</em> yourself.<br>You get to <strong>build</strong> yourself.' },
        { who: 'gpt',  text: '🔔 Every action is a brush stroke in the painting <em>(Ep 2)</em>.<br>🌱 Every environment feeds it new colours <em>(Ep 1)</em>.<br>🧭 Every choice is a vote for who you\'re becoming <em>(Ep 3)</em>.' },
        { who: 'gpt',  text: '<em>"You\'re not discovering who you are.<br>You\'re deciding who you become."</em>' },
      ], 10000, 'The lesson'),
