...
- Feed and social: workout-related image posts/stories can earn +2 XP when Balance verifies the content. Eligible verified activity cards can show +1 XP when shared to the feed. Weekly progress photos earn +10 XP, and sharing that set to the feed can earn another +10 XP. Nudging an inactive friend from Home earns +1 XP, capped once per friend per week.
- Progress and daily cards: weekly progress photo base award +10 XP, daily weigh-in +1 XP, fitness diary +1 XP, and completing all three daily mood check-ins (morning, afternoon, evening) +1 XP.
