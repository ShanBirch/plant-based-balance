(function() {
        ...
        const BACKGROUND_UNLOCKS = [
            ...
            { name: 'beach', displayName: 'The Beach', unlockLevel: 3, icon: '🏖️', theme: 'tamagotchi-bg-beach', image: './assets/beach.jpeg' },
            { name: 'mountain', displayName: 'Mountain Peak', unlockLevel: 5, icon: '🏔️', theme: 'tamagotchi-bg-mountain', image: './assets/mountain.jpeg' },
            { name: 'home', displayName: 'Home Gym', unlockLevel: 7, icon: '🏡', theme: 'tamagotchi-bg-home', image: './assets/home.jpeg' },
            { name: 'park', displayName: 'The Park', unlockLevel: 9, icon: '🌳', theme: 'tamagotchi-bg-park', image: './assets/park.jpeg' },
            { name: 'mt_paozu', displayName: 'Mountain Village', unlockLevel: 11, icon: '⛰️', theme: 'tamagotchi-bg-park', image: './assets/mt_paozu.png' },
            { name: 'kame_house', displayName: 'Island Retreat', unlockLevel: 13, icon: '🏝️', theme: 'tamagotchi-bg-beach', image: './assets/kame_house.png' },
            { name: 'pilaf', displayName: 'Ancient Castle', unlockLevel: 15, icon: '🏰', theme: 'tamagotchi-bg-none', image: './assets/pilaf_castle.png' },
            { name: 'muscle_tower', displayName: 'Ice Fortress', unlockLevel: 17, icon: '❄️', theme: 'tamagotchi-bg-none', image: './assets/muscle_tower.png' },
            { name: 'arena', displayName: 'The Arena', unlockLevel: 19, icon: '🏆', theme: 'tamagotchi-bg-arena', image: './assets/tournament_arena.png' },
            { name: 'korin', displayName: 'Cloud Tower', unlockLevel: 21, icon: '☁️', theme: 'tamagotchi-bg-mountain', image: './assets/korin_tower.png' },
            { name: 'lookout', displayName: 'Sky Sanctuary', unlockLevel: 23, icon: '🏛️', theme: 'tamagotchi-bg-mountain', image: './assets/kamis_lookout.png' },
            { name: 'wasteland', displayName: 'Wasteland', unlockLevel: 25, icon: '🏜️', theme: 'tamagotchi-bg-mountain', image: './assets/wasteland.png' },
            { name: 'snake_way', displayName: 'Spirit Path', unlockLevel: 27, icon: '🌈', theme: 'tamagotchi-bg-none', image: './assets/snake_way.png' },
            { name: 'king_kai', displayName: 'Tiny Planet', unlockLevel: 29, icon: '🪐', theme: 'tamagotchi-bg-none', image: './assets/king_kais_planet.png' },
            { name: 'namek', displayName: 'The Green Planet', unlockLevel: 31, icon: '🌌', theme: 'tamagotchi-bg-mountain', image: './assets/planet_namek.png' },
            { name: 'frieza_ship', displayName: 'Space Station', unlockLevel: 33, icon: '🛸', theme: 'tamagotchi-bg-none', image: './assets/frieza_ship.png' },
            { name: 'dying_namek', displayName: 'Volcanic World', unlockLevel: 35, icon: '🌋', theme: 'tamagotchi-bg-mountain', image: './assets/dying_namek.png' },
            { name: 'time_chamber', displayName: 'The Void Chamber', unlockLevel: 37, icon: '⚪', theme: 'tamagotchi-bg-none', image: './assets/time_chamber.png' },
            { name: 'cell_arena', displayName: 'Championship Ring', unlockLevel: 39, icon: '🥋', theme: 'tamagotchi-bg-arena', image: './assets/cell_arena.png' },
            { name: 'kai_world', displayName: 'Sacred Grounds', unlockLevel: 41, icon: '🌳', theme: 'tamagotchi-bg-none', image: './assets/supreme_kai_world.png' },
            { name: 'inside_buu', displayName: 'The Mind Realm', unlockLevel: 43, icon: '🧠', theme: 'tamagotchi-bg-none', image: './assets/inside_buu.png' },
            { name: 'rocky_canyon', displayName: 'Rocky Canyon', unlockLevel: 45, icon: '☄️', theme: 'tamagotchi-bg-mountain', image: './assets/rocky_canyon.png' },
            { name: 'beerus', displayName: 'Cosmic Temple', unlockLevel: 47, icon: '🌠', theme: 'tamagotchi-bg-none', image: './assets/beerus_planet.png' },
            { name: 'grand_palace', displayName: 'Grand Palace', unlockLevel: 50, icon: '✨', theme: 'tamagotchi-bg-none', image: './assets/grand_palace.png' },
        ];
