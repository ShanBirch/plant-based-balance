...
assert.match(dashboard, /pbb-premium-overlays\.css\?v=90/, 'phones should fetch the updated header styling');
...
assert.match(serviceWorker, /const CACHE_NAME = 'pbb-app-v265'/, 'the app shell cache should advance for the new header');
