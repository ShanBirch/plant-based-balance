...
if (window._pbbIsIOSSafari) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        _chainLoad('https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2', 'scripts_supabase_loaded', 200, function() {
            ...
            _chainLoad('lib/supabase.js?v=16-meal-reminders-retired', 'scripts_supabase_js_loaded', 500, function() {
...
_chainLoad('lib/auth-guard.js?v=13-account-first-flow', 'scripts_auth_guard_loaded', 0, function() {
    ...
    document.write('<script src="lib/supabase.js?v=16-meal-reminders-retired"><\/script>');
