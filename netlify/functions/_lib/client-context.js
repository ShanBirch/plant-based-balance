...
- Course: the Scholar Health IQ card sits at the top. The expandable curriculum runs in this order: Balance Foundations, How Your Body Moves, Fuel for Results, Make Progress Stick, Train With Purpose, Build Muscle Intelligently, Energy, Hormones & Recovery, then Healthy for Life. Tap a course to reveal its topics, then tap an available topic to begin. Each course must be completed before the next unlocks, and existing lesson progress still counts. Quiz Battle is launched from Feed, not Course.
