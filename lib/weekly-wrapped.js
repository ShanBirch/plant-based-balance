...
(function(){
  ...
  function buildAskConditioningReel(){
    ...
    return [
      ...
      twLine('gpt',  'They\'ve studied this for a hundred years.',                          { speed: NORM, pause: 900 }),
      twLine('gpt',  'Lights. Jingles. Coin clatter. Occasional wins.',                     { speed: NORM, pause: 900 }),
      twLine('gpt',  'All paired. All the time.',                                           { speed: SLOW, pause: 900 }),
      twLine('gpt',  'Your brain learns: <em>this place predicts dopamine.</em>',           { speed: NORM, pause: 1100 }),
      twLine('gpt',  'Soon the lights alone light you up.',                                 { speed: NORM, pause: 900 }),
      twLine('gpt',  'You\'re not chasing the money.',                                      { speed: SLOW, pause: 800 }),
      twLine('gpt',  'You\'re chasing the <strong>prediction</strong>.',                    { speed: SLOW, pause: 1300 }),
      ...
      twLine('gpt',  'Every one of them is teaching your prediction engine something.',     { speed: NORM, pause: 1300 }),

      // ── THE FIX ──────────────────────────────────────────────
      twLine('user', 'How do I un-teach the bad ones?',                                     { speed: FAST, pause: 700 }),
      twLine('gpt',  '<strong>Break the pair.</strong>',                                    { speed: SLOW, pause: 1000 }),
      twLine('gpt',  'Ring the bell. Don\'t serve the steak.',                              { speed: NORM, pause: 900 }),
      twLine('gpt',  'Phone buzzes → leave it face-down.',                                  { speed: NORM, pause: 800 }),
      twLine('gpt',  'Fridge opens at 9pm → water, not biscuits.',                          { speed: NORM, pause: 900 }),
      twLine('gpt',  'Do it enough times…',                                                 { speed: SLOW, pause: 800 }),
      twLine('gpt',  'and the bell <strong>stops meaning anything</strong>.',                { speed: SLOW, pause: 1500 }),
