...
const campaigns = [
  ...
  },
  {
    ...
    accent: colours.gold,
    composition: 'gallery',
    primaryText: 'The Balance Foundations Founders Pass is simple. Pay AU$89 once, follow the six-week course, and get one weekly check-in and plan review with me. It does not auto-renew. Message “BALANCE” and I will show you what is included.',
  ...
  },
  {
    ...
    proofFit: 'contain',
    primaryText: 'Plant-based fitness does not need more noise. Balance Foundations puts training, nutrition and progress tools into a six-week course, with one weekly check-in and plan review from me. The Founders Pass is AU$89 once and does not auto-renew. Message “BALANCE” for details.',
  ...
  },
  {
    ...
    primaryText: 'Your environment shapes what gets repeated. Balance Foundations gives you a plant-based community where training, progress and support live together for a clear six-week starting block. It includes one weekly review with me for AU$89 once. Message “BALANCE” to see what is included.',
...
const campaignPlan = {
  ...
  offer: 'Balance Foundations Founders Pass, AU$89 once',
  ...
  dmWelcome: {
    ...
    appPreview: null,
    offerMessage: "Balance Foundations brings your weekly plan, plant-based nutrition, progress, learning and community into one six-week course. The Founders Pass is AU$89 once, includes my weekly review, and does not auto-renew.",
    quickReplies: [],
