...
- Francesca's workout created on 2026-07-31 is a known incomplete case: it has only three exercises and only one has a video. Before treating that workout as ready, rebuild or complete it from the video-backed exercise library and verify the result in her Cycle/calendar UI.
