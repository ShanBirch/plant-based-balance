      ...
      try {
        ...
        if (profileError) {
          ...
          if (window.userProfile && typeof window.userProfile === 'object') {
            window.userProfile.weight = roundedWeightKg;
          }
          ...
          ['localStorage', 'sessionStorage'].forEach((storageName) => {
            try {
              ...
              profile.weight = roundedWeightKg;
          ...
          if (typeof document !== 'undefined') {
            ...
            if (weightDisplay) weightDisplay.textContent = `${roundedWeightKg} kg`;
          }
        }
      } catch (syncError) {
