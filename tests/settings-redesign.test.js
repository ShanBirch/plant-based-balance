...
test('phone caches receive the redesign', () => {
  assert.match(dashboard, /pbb-premium-overlays\.css\?v=130-replay-settings-card/);
  assert.match(serviceWorker, /const CACHE_NAME = 'pbb-app-v550-replay-settings-card'/);
});
