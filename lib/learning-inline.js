        ...
        'fuel-1': [
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Order the steps of managing energy balance from first to last:", items: ["Estimate your calories IN (everything you eat and drink)", "Estimate your calories OUT (metabolism + activity + digestion)", "Compare the two numbers", "If calories in > out = weight gain; if calories in < out = weight loss", "Adjust your intake or activity as needed based on your goal"]},
        ...
        'fuel-2': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Arrange these from FEWEST calories per gram to MOST calories per gram:", items: ["Protein — 4 calories per gram", "Carbohydrates — 4 calories per gram (tied with protein)", "Alcohol — 7 calories per gram (not technically a macro)", "Fat — 9 calories per gram (the most calorie-dense)"]},
        ...
        'fuel-4': [
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Rank from MOST to LEAST important: What matters most after a workout?", items: ["Getting adequate protein (20-40g) — the #1 priority", "Eating carbohydrates to replenish glycogen stores", "Overall food quality (whole foods over processed)", "Eating within exactly 30 minutes — this matters much less than people think"] },
            ...
            },
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Rank from MOST to LEAST important when planning your meals:", items: ["Hitting your total daily nutrition targets (calories and macros)", "Choosing an eating pattern you can actually sustain long-term", "Spreading protein intake throughout the day (not all in one meal)", "The specific number of meals per day — this matters least"] },
        ...
        'hormones-2': [
            {
                ...
                games: [
                    ...
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Order from trigger to full activation: What happens during an adrenaline response?", items: ["Brain predicts a demanding or threatening situation", "Adrenal glands release adrenaline into the bloodstream", "Heart rate increases to pump more blood", "Blood redirects away from digestion and toward muscles", "Glucose floods into the bloodstream for immediate energy"]},
