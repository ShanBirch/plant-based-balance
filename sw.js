const CACHE_NAME = 'pbb-app-v268'; // v268: earned share celebrations and Instagram-safe branding
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=37',
