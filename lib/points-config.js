...
export const POINTS_CONFIG = {
  ...
  POINTS_PER_WORKOUT_STORY: 2,  // 2 points for sharing workout story (encourages social sharing)
  ...
  // === PREMIUM CHALLENGES ===
  CHALLENGE_PREMIUM_PRICE: 9.99,        // $9.99 AUD for premium challenge entry
  CHALLENGE_PREMIUM_MULTIPLIER: 2,      // 2x XP and points for premium participants
};

/**
 * Challenge Premium Configuration
 * Premium challenge participants get double XP and double points
 */
export const CHALLENGE_PREMIUM = {
  PRICE_AUD: 9.99,
  STRIPE_PRICE_ID: 'price_challenge_premium_999',  // Create this in Stripe
  MULTIPLIER: 2,  // 2x points multiplier
  BENEFITS: [
    'Double XP for all activities',
    'Double points earned during challenge',
