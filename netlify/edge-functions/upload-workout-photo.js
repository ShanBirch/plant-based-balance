/**
 * Netlify Edge Function to upload workout photos to Backblaze B2
 * Handles photo uploads from the workout verification feature
 */
...
export default async (request, context) => {
    ...
    try {
        ...
        const fileName = `workouts/${userId}/${timestamp}.${fileExtension}`;
        ...
        const uploadResponse = await fetch(uploadUrl, {
            ...
            headers: {
                ...
                'X-Bz-Info-upload-type': 'workout-photo'
            },
            body: fileBuffer
        });
        ...
        console.error('Error in upload-workout-photo:', error);
        return new Response(JSON.stringify({
