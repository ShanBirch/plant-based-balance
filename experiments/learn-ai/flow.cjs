...
function catalogue(now = new Date()) {
  return {
    ...
    bec_kirsty: {type: 'image', url: 'https://plantbased-balance.org/photos/client-success/bec-kirsty-cocos.png', facts: 'Shared accountability. Both lost over 10kg and got stronger. Timeframe for this shared transformation is not yet confirmed; do not borrow Kristy’s separate 26-week photo timeframe or invent one.'},
