const CACHE_NAME = 'pbb-app-v351-photo-retry'; // v351: working meal-photo generation, retryable tour gate, unobstructed voice note
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=198-photo-retry',
