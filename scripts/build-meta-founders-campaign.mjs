...
const campaigns = [
  {
    ...
    title: ["YOU HAVEN'T FAILED.", 'THE PLAN WAS WRONG.'],
    body: ['Coaching built around your brain,', 'your experiences and real life'],
    price: 'AU$89.99 ONCE',
    cta: 'SEND MESSAGE',
    accent: colours.deepGold,
    composition: 'portrait',
    primaryText: "You haven't failed. The plan was wrong. It wasn't built around your brain, what you've been through, or what you're dealing with now. Balance Foundations gives plant-based people a clear six-week starting course with my weekly review. The Founders Pass is AU$89.99 once and does not auto-renew. Message “BALANCE” and I'll show you what's included.",
  ...
  },
  {
    ...
    price: 'FOUNDATIONS  •  AU$89.99 ONCE',
    cta: 'MESSAGE “BALANCE”',
    accent: colours.sage,
    composition: 'portrait',
  ...
  },
  {
    ...
    accent: colours.gold,
    composition: 'gallery',
    primaryText: 'The Balance Foundations Founders Pass is simple. Pay AU$89.99 once, follow the six-week course, and get one weekly check-in and plan review with me. It does not auto-renew. Message “BALANCE” and I will show you what is included.',
  ...
  },
  {
    ...
    proofFit: 'contain',
    primaryText: 'Plant-based fitness does not need more noise. Balance Foundations puts training, nutrition and progress tools into a six-week course, with one weekly check-in and plan review from me. The Founders Pass is AU$89.99 once and does not auto-renew. Message “BALANCE” for details.',
  ...
  },
  {
    ...
    primaryText: 'Your environment shapes what gets repeated. Balance Foundations gives you a plant-based community where training, progress and support live together for a clear six-week starting block. It includes one weekly review with me for AU$89.99 once. Message “BALANCE” to see what is included.',
  ...
  },
  {
    ...
    accent: colours.sage,
    composition: 'founder',
    primaryText: 'I built Balance because plant-based fitness should feel less lonely and less complicated. I am an exercise scientist and former gym owner, and I coach change through small, clear steps that fit real life. The Foundations Founders Pass gives you a six-week course and my weekly review for AU$89.99 once, with no auto-renewal. Message “BALANCE” and I will talk you through it.',
...
const campaignPlan = {
  ...
  offer: 'Balance Foundations Founders Pass, AU$89.99 once',
  ...
  dmWelcome: {
    ...
    appPreview: null,
    offerMessage: "Balance Foundations brings your weekly plan, plant-based nutrition, progress, learning and community into one six-week course. The Founders Pass is AU$89.99 once, includes my weekly review, and does not auto-renew.",
    quickReplies: [],
  ...
  rollout: {
    phase1: ["A1 | You haven't failed. The plan was wrong.", 'A4 | Plant-based fitness, made clearer', 'A5 | Plant-based fitness is better together', "V1 | You haven't failed. The plan was wrong."],
    phase1Days: 7,
