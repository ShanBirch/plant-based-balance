...
(function() {
    ...
    const LESSONS = {
        ...
        'mind-6': [
            {
                id: 'mind-6-1', unitId: 'mind-6', order: 1, title: "The Willpower Myth",
                content: {
                    intro: `Here's something that contradicts almost everything you've been taught about change: willpower doesn't work.\n\nWe've been told that successful people have more discipline, more self-control, more grit. But research tells a different story. Studies show that willpower is a limited resource that depletes throughout the day. People who appear to have great self-control aren't actually better at resisting temptation—they've structured their lives so they encounter less temptation in the first place.\n\nYour brain isn't built for constant resistance. It's built for prediction and automation. Trying to overpower your predictions with willpower is like trying to steer a river by standing in it.`,
                    keyPoint: "Willpower is limited and depletes with use. People who seem disciplined have designed environments that don't require willpower—not stronger self-control.",
                },
                games: [
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "People who successfully maintain healthy habits have stronger willpower than everyone else.", answer: false, explanation: "Research shows they don't have more willpower—they've structured their environment so they need less of it." },
                    { type: GAME_TYPES.FILL_BLANK, sentence: "Willpower is a limited resource that _______ throughout the day.", options: ['depletes', 'increases', 'stabilizes', 'multiplies'], answer: 'depletes' },
                    { type: GAME_TYPES.SCENARIO_STORY, scenario: "Two coworkers both want to eat healthier. Person A keeps junk food in their desk but uses willpower to resist it. Person B removed all junk food and keeps fruit on their desk instead.", question: "Who is more likely to eat healthy long-term?", options: [
                        { text: "Person A—willpower gets stronger with practice", correct: false },
                        { text: "Person B—they removed the need for willpower entirely", correct: true },
                        { text: "Neither—it depends on motivation", correct: false },
                    ], explanation: "Person B isn't 'stronger'—they're smarter. They eliminated the prediction trigger for junk food instead of fighting it." },
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        { left: "Willpower approach", right: "Fight your predictions" },
                        { left: "Environment approach", right: "Change what triggers predictions" },
                        { left: "Discipline myth", right: "Successful people resist more" },
                        { left: "Reality", right: "Successful people encounter less temptation" },
                    ]},
                    { type: GAME_TYPES.TAP_ALL, question: "Why does relying on willpower usually fail?", options: [
                        { text: "Willpower depletes with use throughout the day", correct: true },
                        { text: "You're fighting automated brain predictions", correct: true },
                        { text: "People just aren't trying hard enough", correct: false },
                        { text: "Resistance creates mental fatigue", correct: true },
                        { text: "Everyone has unlimited willpower", correct: false },
                    ]},
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "Why does the willpower approach collapse?", items: ["You decide to resist a temptation", "Willpower depletes through the day", "Brain's automatic predictions keep firing", "Eventually willpower runs out", "You do the predicted behavior anyway"]},
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "Trying to overpower your brain's predictions with willpower is a reliable strategy.", answer: false, explanation: "Your predictions are automatic and tireless. Willpower is conscious and limited. The predictions will outlast your resistance every time." },
                    { type: GAME_TYPES.FILL_BLANK, sentence: "People who appear disciplined have structured their lives to encounter less _______.", options: ['temptation', 'opportunity', 'challenge', 'food'], answer: 'temptation' },
                ]
            },
            {
                id: 'mind-6-2', unitId: 'mind-6', order: 2, title: "Your Context Is Your Autopilot",
                content: {
                    intro: `Research suggests that roughly 43% of what you do each day is performed automatically, driven by context rather than conscious choice.\n\nYour brain is always asking: "What usually happens here?" Walk into the kitchen—eating prediction activates. Sit on the couch—scrolling prediction activates. Enter the gym—exercise prediction activates.\n\nThis is the counter-intuitive truth: you don't decide most of your behavior. Your environment decides it for you by activating predictions. The same person acts completely differently in different contexts—not because they "chose" to, but because different environments trigger different predictions.`,
                    keyPoint: "Most daily behavior is automatic and context-driven. Your environment activates predictions that drive action—often without any conscious decision.",
                },
                games: [
                    { type: GAME_TYPES.FILL_BLANK, sentence: "Research suggests roughly _______% of daily behavior is performed automatically.", options: ['43', '10', '75', '5'], answer: '43' },
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "You consciously decide most of the actions you take in a typical day.", answer: false, explanation: "Most behavior is automatic—driven by context and predictions, not conscious choice." },
                    { type: GAME_TYPES.SCENARIO_STORY, scenario: "You eat healthy all day at work but overeat every night at home on the couch watching TV. You blame your 'lack of discipline' in the evening.", question: "What's actually happening?", options: [
                        ...
                        { text: "Different environments trigger different predictions—couch + TV predicts snacking", correct: true },
                        { text: "You're just a different person at night", correct: false },
                    ], explanation: "The couch-TV context triggers a snacking prediction. At work, there's no such trigger. It's the environment, not your character." },
                    { type: GAME_TYPES.MATCH_PAIRS, pairs: [
                        ...
                        { left: "Lie in bed", right: "Sleep prediction activates" },
                    ]},
                    { type: GAME_TYPES.TAP_ALL, question: "What does 'context is your autopilot' mean?", options: [
                        { text: "Your surroundings determine which predictions fire", correct: true },
                        { text: "The same person behaves differently in different environments", correct: true },
                        { text: "You have no free will at all", correct: false },
                        { text: "Most behavior is triggered by context, not conscious choice", correct: true },
                        { text: "Environments don't affect behavior", correct: false },
                    ]},
                    { type: GAME_TYPES.ORDER_SEQUENCE, question: "How does context drive behavior?", items: ["You enter an environment", "Brain asks 'what usually happens here?'", "Context activates stored predictions", "Predictions trigger automatic behavior", "You act without consciously deciding"]},
                    { type: GAME_TYPES.SWIPE_TRUE_FALSE, question: "The same person can behave completely differently in different environments because different contexts trigger different predictions.", answer: true, explanation: "You at the gym vs. you on the couch are driven by different predictions. Context is the switch." },
                    { type: GAME_TYPES.FILL_BLANK, sentence: "You don't decide most of your behavior. Your _______ decides it for you.", options: ['environment', 'motivation', 'personality', 'genetics'], answer: 'environment' },
                ]
            },
            {
            ...
            },
            {
                ...
                content: {
                    intro: `Stop trying to become a "better" person. Start building a better system.\n\nThis feels like cheating—like you're supposed to be strong enough to resist temptation, disciplined enough to force yourself, motivated enough to push through. But that's the myth talking.\n\nThe science is clear: reduce friction for behaviors you want, increase friction for behaviors you don't. Put the vegetables at eye level. Put running shoes by the door. Delete social media from your phone. Make the healthy choice the easy choice.\n\nYou're not weak for needing this. You're working WITH your brain instead of against it. Your predictive brain will automate whatever the environment makes easiest.`,
                    keyPoint: "Change your environment, not yourself. Reduce friction for desired behaviors, increase friction for unwanted ones. Work with your predictive brain, not against it.",
                },
                games: [
...
There's no perfect program—only the one you'll actually do consistently with effort. Start where you are, apply the principles, and trust the process.`,
    ...
    async function completeLesson() {
        ...
        const result = { xp_earned: finalXpEarned, is_new_lesson: dbIsNewLesson, needs_perfect_score: dbNeedsPerfectScore, daily_quiz_bonus: dailyQuizBonus };
