...
- Course: the Scholar Health IQ card sits at the top. The expandable curriculum runs in this order: Balance Foundations, How Your Body Moves, Fuel for Results, Make Progress Stick, Train With Purpose, Build Muscle Intelligently, Energy, Hormones & Recovery, then Healthy for Life. Every course card can be opened to preview its topics. Completing Balance Foundations unlocks all seven specialist courses; before then, their topics can be viewed but not started. Existing lesson progress still counts. Quiz Battle is launched from Feed, not Course.
