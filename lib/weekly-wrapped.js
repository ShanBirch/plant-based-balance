...
(function(){
  ...
  function buildChallengeReel(){
    return [
      ...
      { bg: 'ww-bg-jackpot', hold_ms: 3800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-halftone"></div>
        ...
        <div class="ww-stamp gold" style="margin-top:18px;">GIVEAWAY</div>
      `},
      // 2. FREE to enter
      ...
      { bg: 'ww-bg-electric', hold_ms: 4800, html: `
        ...
        <div class="ww-caption" style="margin-top:12px;">One winner. One giveaway. That's it.</div>
      `},
      // 4. WAYS TO EARN XP
      ...
      `},
      // 5. LEADERBOARD — visual
      { bg: 'ww-bg-aurora', hold_ms: 4800, html: `
        <div class="ww-speed-lines"></div>
        <div class="ww-kicker">Live leaderboard</div>
      ...
      `},
      // 6. STAKES — winner takes the giveaway
      { bg: 'ww-bg-jackpot', hold_ms: 4500, html: `
        <div class="ww-halftone"></div>
        <div class="ww-kicker">Top of the board after 30 days</div>
        <div class="ww-big-num" style="font-size: clamp(4rem, 20vw, 10rem); text-shadow: 4px 4px 0 #052e16;">🎁</div>
        <div class="ww-caption" style="font-weight:800;">takes the full <strong>$500 giveaway</strong>.</div>
        <div class="ww-stamp gold" style="margin-top:18px;">WINNER TAKES IT</div>
      `},
      // 7. URGENCY — the date
      ...
      { bg: 'ww-bg-intro', hold_ms: 8500, html: `
        ...
        <div class="ww-caption" style="font-size:0.9rem; margin-top:4px; opacity:0.92;">$500 XP Giveaway · Starts 27 April</div>
