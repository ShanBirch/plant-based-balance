...
_chainLoad('lib/auth-guard.js?v=14-resume-session', 'scripts_auth_guard_loaded', 0, function() {
...
document.write('<script src="lib/auth-guard.js?v=14-resume-session"><\/script>');
