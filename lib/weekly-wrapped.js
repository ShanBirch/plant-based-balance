  ...
  function buildChallengeReel(){
    return [
      ...
      { bg: 'ww-bg-workouts', hold_ms: 5000, html: `
        ...
        <div style="font-size: clamp(2.4rem, 10vw, 4.8rem); line-height:1.15; margin-top:10px;">🏋️ logging workouts<br>📸 tracking meals<br>🎓 finishing lessons<br>🔥 keeping your streak</div>
        <div class="ww-caption" style="margin-top:16px;">Every action counts. Every day adds up.</div>
      `},
