...
function buildEvaluationPrompt({ leadName, channel, currentQualifier, history, currentMessage, draftText, customData, meaningfulLeadReplyCount }) {
    ...
    return `You are scoring a lead's progress through a 4-stage qualifier funnel for Shannon, who is currently offering the Balance Vegan Fitness Founders Pass. It is AUD $99 once, does not need a phone call, and includes a six-week introduction to coaching with Shannon available in the app for questions, direction and accountability, plus lifetime access to the core Balance app and vegan fitness community. It does not include instant daily replies or fully customised weekly plan reviews. Starter Coaching at AUD $29.99/week is the optional ongoing upgrade. Close the Founders Pass through DMs by default. Balance no longer uses a free challenge as its acquisition or conversion path.
