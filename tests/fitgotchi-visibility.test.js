...
assert.match(dashboard, /dashboard-script-10-points_widget_functions\.js\?v=\d+/, 'phones should fetch versioned points updates');
assert.match(serviceWorker, /const CACHE_NAME = 'pbb-app-v530-fitgotchi-guide-bootstrap'/, 'the app shell cache should advance for this feature');
