const CACHE_NAME = 'pbb-app-v254'; // v254: open character design on a new member's first FitGotchi reveal
...
const ASSETS = [
  ...
  './js/dashboard/dashboard-script-5-initialize_stripe_for_inapp_pu.js?v=146',
  './js/dashboard/dashboard-script-7-video_logic.js?v=20260603-video-stream',
  './js/dashboard/dashboard-script-10-points_widget_functions.js?v=28',
